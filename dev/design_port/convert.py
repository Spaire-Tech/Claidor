...
def main() -> None:
    ...
    logic = logic.replace("class Component extends DCLogic", "class ClaidorDesignApp extends React.Component<any, any>")
    OUT_APP.write_text(
        "// GENERATED by dev/design_port/convert.py — the design's own\n"
        "// component logic (docs/design/claidor-v1-app.jsx), verbatim, with\n"
        "// the runtime base class swapped for React.Component and the\n"
        "// generated view as its render.\n"
        "// @ts-nocheck\n"
        "/* eslint-disable */\n"
        "'use client'\n\n"
        "import React from 'react'\n"
        "import { DesignView } from './View'\n\n"
        + logic.replace("\u2019", "\u2019")
        + "\n"
