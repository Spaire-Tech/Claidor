...
import { SaveToClaidor } from "./features/integration/SaveToClaidor";
      ...
      <div className="app-body">
        <div className="review review--results">
          ...
          <div className="review__body">
            ...
            <SaveToClaidor mode="review" redlines={RESULT.redlines} title="NDA (reviewed)" />
            {visible.length === 0 ? (
        ...
        <div className="stack authority-view">
          <div className="row" style={{ justifyContent: "space-between" }}>
            <div className="row" style={{ gap: 6, alignItems: "center" }}>
              ...
              <InfoTip side="left" text="Checks every case citation in the document against Claidor's US case-law corpus. Verified means a real matching case was found. No match can mean a hallucinated, mis-typed, or unreported citation, so confirm it yourself before you rely on it or file." />
            </div>
