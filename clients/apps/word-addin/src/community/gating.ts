 ...
 * Claidor's hosted data or account throws REQUIRES_ACCOUNT. These helpers let the
 ...
 */
export const REQUIRES_ACCOUNT_NOTE = "Requires a Claidor account";

/** Surfaces that only make sense with a hosted Claidor account. */
 ...
 * CourtListener). Statute resolution still needs Claidor's corpus and stays off.
 */
