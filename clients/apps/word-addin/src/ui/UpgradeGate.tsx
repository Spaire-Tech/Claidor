...
/** Where the "Get Claidor hosted" upsell points. One place to change it. */
export const HOSTED_URL = "https://YOUR-APP-DOMAIN.example.com/auth/signup";
...
/**
 * Community-edition upsell card. Shown where a feature needs Claidor's hosted
...
export function UpgradeLink({ label }: { label: string }) {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      title="Available on the Claidor hosted plan"
