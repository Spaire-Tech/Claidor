...
export function ContextMenu({
  ...
  // Claidor backend/account. In the community/BYOK edition none of them apply,
      ...
      <div className="ctx-menu" role="dialog" aria-modal="true" aria-label="Context sources">
        ...
        {community ? (
          <p className="ctx-menu__note small muted">
            Case law, matter documents, and web search are on the Claidor hosted plan. Attach a
