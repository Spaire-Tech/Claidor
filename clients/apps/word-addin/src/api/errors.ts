/**
 * Typed API errors mapped from the Claidor backend error contract.
...
export function friendlyMessage(err: ApiError): string {
  switch (err.kind) {
    case "quota":
      return "You have reached your usage limit for this plan. Open Claidor to upgrade or wait for your quota to reset.";
    case "too_large":
    ...
    case "network":
      return "Cannot reach Claidor. Check your connection and try again.";
    case "server":
      return "Claidor had a problem completing that. Please try again.";
    default:
