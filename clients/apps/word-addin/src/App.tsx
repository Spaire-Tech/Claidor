    ...
    getMe()
      .then((me) => {
        ...
        if (me.initialized === false) {
          setAuthNotice(
            "You do not have a Claidor account yet. Create one on the web, then sign in here.",
          );
    ...
    <div className="app">
      ...
      {!authed ? (
        ...
        <header className="appbar">
          <a
            href="https://YOUR-DOMAIN.example.com"
            target="_blank"
            rel="noreferrer"
            className="appbar__brand"
            title="Claidor"
            aria-label="Open the Claidor website in your browser"
          >
            <img
