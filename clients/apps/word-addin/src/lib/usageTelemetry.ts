 ...
 * users, because they run on their own AI key with no Claidor account and never
...
const ANON_ID_KEY = "claidor.byok.anonId";
const OPT_OUT_KEY = "claidor.byok.usageOptOut";
const LAST_PING_KEY = "claidor.byok.lastPingAt";
