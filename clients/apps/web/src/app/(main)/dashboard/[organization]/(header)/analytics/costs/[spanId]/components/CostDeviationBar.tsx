    ...
    <Tooltip>
      <TooltipTrigger asChild>
        <div className="box-content flex h-1.5 w-12 cursor-help items-center py-2">
          <div className=" flex h-full w-1/2 justify-end overflow-hidden rounded-l-full bg-gray-200">
          ...
          <div className=" h-2.5 w-0.5 rounded-full bg-gray-400" />
          <div className=" h-full w-1/2 overflow-hidden rounded-r-full bg-gray-200">
            {deviation.isAboveAverage && (
              <div
          ...
          <div className=" border-t border-gray-200 pt-2">
            <div className="flex items-center gap-2 text-xs">
              <div className="flex h-1.5 w-8 items-center">
                ...
                <div className=" h-full w-1/2 rounded-r-full bg-gray-300" />
              </div>
            ...
            <div className="mt-1 flex items-center gap-2 text-xs">
              <div className="flex h-1.5 w-8 items-center">
                <div className=" h-full w-1/2 rounded-l-full bg-gray-300" />
                <div className=" h-2 w-0.5 bg-gray-400" />
                <div
