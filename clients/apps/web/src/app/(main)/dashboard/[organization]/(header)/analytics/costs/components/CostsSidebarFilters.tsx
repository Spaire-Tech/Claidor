  ...
  return (
    <div
      className={twMerge(
        ...
        hasScrolled && ' border-t border-gray-200',
      )}
...
function EventStatisticsCard({
  ...
  return (
    <Link
      ...
      className={twMerge(
        ' flex cursor-pointer flex-col justify-between gap-5 rounded-2xl border px-3 pt-2 pb-3 transition-colors',
        isSelected
    ...
    >
      <div className="flex flex-col justify-between gap-1.5">
        ...
        <dl className=" flex max-w-sm items-center gap-4 font-mono text-gray-500">
      ...
      <div className=" -m-2 flex flex-1 flex-col rounded-xl bg-gray-50 p-1">
