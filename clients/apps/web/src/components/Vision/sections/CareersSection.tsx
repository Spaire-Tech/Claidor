    ...
    >
      <div className="flex flex-col gap-y-6">
        <div className="flex flex-col gap-y-1">
          <h3 className="text-claidor-50">Momentum is Culture</h3>
          <p className="text-claidor-500">
            We focus on keeping, celebrating and accelerating momentum. Allowing
            culture to be continuously improved and fluid vs. fixed.
          </p>
        </div>
        <div className="flex flex-col gap-y-1">
          <h3 className="text-claidor-50">Ship / Refactor / Scale</h3>
          <p className="text-claidor-500">
        ...
        <div className="flex flex-col gap-y-1">
          <h3 className="text-claidor-50">Do your life&apos;s work</h3>
          <p className="text-claidor-500">
