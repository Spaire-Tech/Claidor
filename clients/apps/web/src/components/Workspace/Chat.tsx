...
/** Questions each scope's tools can genuinely answer — in the design
...
export const Chat = ({
  ...
  return (
    <div
      style={{
        //: The design pane: 38% of the row, flat white beside the
    ...
    >
      ...
      {empty && (
        ...
        >
          {/* The Swens mark — the design's Bodoni serif, which
