...
const ImpersonationBanner = () => {
  ...
  useEffect(() => {
    const checkCookie = () => {
      ...
      const hasImpersonationCookie = cookies.some((cookie) =>
        cookie.trim().startsWith('claidor_is_impersonating='),
      )
  ...
  return (
    <div className="sticky top-0 z-50 flex flex-row items-center justify-between bg-red-100 px-8 py-2 text-sm text-red-600">
