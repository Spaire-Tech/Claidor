...
export const IOSAppBanner = () => {
  ...
  return (
    <div className=" relative flex flex-col gap-3 rounded-xl border border-gray-200 bg-white p-6 pt-8 text-sm md:hidden">
      <button
        type="button"
        onClick={dismiss}
      ...
      <div className="flex flex-col gap-1">
        <span className="font-medium">Claidor is now available on App Store</span>
