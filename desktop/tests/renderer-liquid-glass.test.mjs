...
test("the glass block frosts the sidebar, panes, composer, menus, dialogs and pills, and applies once", async () => {
  ...
  for (const surface of [".sand-agents-sidebar", ".sand-info-pane", ".sand-prompt-shell", ".sand-new-chat-menu", "[role=dialog].sand-10e981r", ".sand-new-messages-pill", ".sand-message-hover-actions", ".sand-computer-top-bar"]) {
  ...
  assert.doesNotMatch(LIQUID_GLASS_CSS, /sand-message-card|sand-message-prose|sand-mvmkjj/, "messages are content, not chrome");
