/**
 * Where the failing model comes from in Swen terms, so users can tell at
 * a glance whether an error concerns the Swen plan, a vendor coding plan
...
export interface CoworkErrorDetail {
  /** Runtime error message before Swen i18n normalization. */
  rawErrorMessage?: string;
  provider?: string;
  model?: string;
  /** Swen-side classification of where the failing model comes from. */
