...
// ─── Provider Name ──────────────────────────────────────────────────────
// providerName identifies the Swen internal provider (config key).
...
const PROVIDER_DEFINITIONS = [
  ...
  // ── Global ──
  {
    ...
    openClawProviderId: OpenClawProviderId.SwenCopilot,
