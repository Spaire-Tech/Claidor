...
export const MATIES_CLIENT_CAPABILITIES_HEADER = 'X-Maties-Client-Capabilities';
export const MATIES_CLIENT_VERSION_HEADER = 'X-Maties-Client-Version';
...
export const MATIES_CLIENT_CAPABILITIES = [
