...
export const CHIEF_OF_STAFF_RULES = [
  ...
  // Relaying in your own words is now a rule for every agent, in the
  // shared brief ("What the person said to you was said to you"), because
  // any agent can message any other and so any agent can repeat a vent.
  // Said once, there, rather than twice in the one file Yodo reads.
