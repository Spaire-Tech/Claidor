...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aiSkinCreationGuide: '可前往“专家套件”使用「Caisra 外观定制」，或直接开始创作。',
    ...
    aiSkinDeleteManagedCopyNote: '只会删除 Caisra 管理的皮肤副本，不会删除会话中的原始生成图片或卸载 AI 皮肤设计师套件。',
    aiSkinDeleteFailed: '删除皮肤失败，请重试',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 Caisra 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    newUserOnboardingNewTaskDescription:
      '输入一个任务，Caisra 会帮你拆解步骤、生成内容，并推进成结果。',
    newUserOnboardingPromptExample: '帮我做一个金融行业分析报告',
    newUserOnboardingPromptResultTitle: '直接说出你想完成的事',
    newUserOnboardingPromptResultDescription: 'Caisra 会把复杂的事情变成清晰的结果',
    ...
    shortcutDescNewChat: '开始一个新的 Caisra 任务',
    shortcutDescFocusPrompt: '跳回 Caisra 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 Caisra 任务视图',
    ...
    dailyCheckInLoginHint: '登录只在 Caisra 客户端中完成，活动不会获取账号令牌',
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 Caisra Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    enterpriseQuotaMemberMemberDesc: '向团队管理员申请提高成员额度后继续使用 Caisra。',
    enterpriseQuotaMemberAdminDesc: '调整额度后继续使用 Caisra。',
    ...
    enterpriseQuotaPoolMemberDesc: '通知团队管理员购买团队积分包后继续使用 Caisra。',
    enterpriseQuotaPoolAdminDesc: '购买团队积分包后，团队成员可继续使用 Caisra。',
    ...
    artifactPreviewCardLobsterBrowser: 'Caisra',
    artifactPreviewCardOpenInLobsterBrowser: '在 Caisra 中打开',
    ...
    coworkWorkingDirectoryHint: 'Caisra 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 Caisra 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 Caisra 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'Caisra 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkAgentEngineOpenClaw: 'Caisra 引擎（默认）',
    ...
    settingsSavedButOpenClawSyncFailed:
      '设置已保存，但应用到引擎运行环境失败。请重试保存，或重启引擎后再试。',
    ...
    coworkOpenClawInstall: '启动引擎',
    coworkOpenClawRetryInstall: '重试启动引擎',
    coworkOpenClawStart: '启动引擎',
    ...
    coworkOpenClawErrorRepairHint:
      '推荐使用一键修复：自动备份并重建引擎配置后重新启动网关，可解决大多数启动失败问题；不会删除聊天记录、模型配置、技能或工作区文件。',
    ...
    openClawRepairGatewayStateDesc: '备份并重建引擎配置，然后重新启动网关。',
    openClawRepairConfirmTitle: '修复引擎启动问题？',
    ...
    openClawDataBackupBlockingTitle: '正在备份 Caisra 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 Caisra 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 Caisra 数据备份？',
    openClawDataMigrationConfirmDesc:
      '导入会替换当前应用数据，包括登录态、会话、配置、技能、记忆和引擎状态。',
    ...
    coworkMemoryEnabledHint: '引擎会自动索引 MEMORY.md 文件，为 Agent 提供长期记忆检索。',
    ...
    coworkMemoryLegacyNotice: '当前为 Caisra 引擎模式。本页功能仅对 Cowork 生效。',
    ...
    coworkConfigSaveFailed: '保存 Caisra 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'Caisra 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'Caisra 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkHomeTagline: '我是 Caisra，你的全场景办公 Agent',
    ...
    coworkErrorModelSourceLobsterAIPlan: 'Caisra 套餐',
    ...
    // 技能同步 (engine)
    syncSkillsFromOpenClaw: '从引擎同步',
    skillsSyncTitle: '发现新技能',
    skillsSyncFound: '检测到 {count} 个可从引擎同步的技能：',
    skillsSyncNow: '立即同步',
    skillsSyncSkip: '暂不同步',
    skillsSyncLater: '如果现在不同步，后续可以在「添加」菜单中的「从引擎同步」手动操作。',
    ...
    dshSettingsDesc: '内置 DeepSeek 官方开源 agent 框架（dsh）。启用后，Caisra 的模型供应商配置会自动同步给 dsh。',
    ...
    pluginsSourceOpenclaw: '引擎',
    pluginsSyncTitle: '发现新插件',
    pluginsSyncDesc: '从引擎发现并同步插件到管理列表。',
    pluginsSyncButton: '发现插件',
    pluginsSyncing: '正在同步插件...',
    pluginsSyncFound: '检测到 {count} 个可从引擎同步的插件：',
    pluginsSyncNone: '未发现新插件',
    pluginsSyncNow: '立即同步',
    pluginsSyncSkip: '暂不同步',
    pluginsSyncLater: '如果现在不同步，后续可以在「安装插件」页面的引擎分类下手动操作。',
    ...
    imWeixinQrAccountMissing:
      '微信已连接过此引擎，但未找到本地账号 ID。请重新加载状态后再试。',
    ...
    browserProfileManagedDescription: 'Caisra 启动一个专用浏览器，稳定、干净。',
    ...
    browserDiagnosticGatewayReady: '引擎已启动',
    browserDiagnosticGatewayNotRunning: '引擎未启动',
    browserDiagnosticGatewayFailed: '引擎检查失败',
    ...
    browserFollowGlobalProxyDescription:
      '默认开启。关闭后仅作为 Caisra 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'Caisra 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 Caisra 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 Caisra 可以打开此域名',
    ...
    notificationSystemPermissionHint: '若未收到通知，请在系统设置中允许 Caisra 发送通知。',
    ...
    usageAnalyticsEnabled: '帮助改进 Caisra',
  ...
  en: {
    ...
    aiSkinCreationGuide: 'Use “Customize Caisra” in Expert Kits, or start here.',
    ...
    aiSkinDeleteManagedCopyNote: 'Only Caisra-managed skin copies are removed. Original images in the conversation and the AI Skin Designer kit are kept.',
    aiSkinDeleteFailed: 'Failed to delete the skin. Please try again.',
    uiFontSize: 'UI font size',
    uiFontSizeDescription: 'Adjust the base size used for the Caisra UI',
    ...
    copied: 'Copied',
    copyrightHolder: 'Caisra. All rights reserved.',
    ...
    newUserOnboardingNewTaskDescription:
      'Enter a task and Caisra will break it into steps, generate content, and move it toward a result.',
    ...
    newUserOnboardingPromptResultDescription:
      'Caisra turns complex work into clear results',
    ...
    newUserWelcomeTaskContent:
      "Hi, I'm Caisra, your all-purpose office Agent, here to help you solve problems.\n\n"
    ...
    newUserWelcomeInputLockedLabel: 'Sign in to continue with Caisra',
    ...
    shortcutScopeHint:
      'Shortcuts only run while the Caisra window is focused; while a text field is focused, only shortcuts with a Cmd/Ctrl modifier trigger.',
    ...
    shortcutOpenCowork: 'Open Caisra',
    ...
    shortcutDescNewChat: 'Start a new Caisra task',
    shortcutDescFocusPrompt: 'Return to Caisra and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the Caisra task view',
    ...
    dailyCheckInLoginHint: 'Login is handled by Caisra; the activity never receives account tokens',
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit Caisra Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    enterpriseQuotaMemberMemberDesc: 'Request a higher member quota from your team administrator to continue using Caisra.',
    enterpriseQuotaMemberAdminDesc: 'Adjust your quota to continue using Caisra.',
    ...
    enterpriseQuotaPoolMemberDesc: 'Notify your team administrator to purchase a Team credit pack and continue using Caisra.',
    enterpriseQuotaPoolAdminDesc: 'Purchase a Team credit pack so members can continue using Caisra.',
    ...
    siteQuotaChooseHint: 'Choose an online site. Caisra will never stop one automatically.',
    ...
    artifactPreviewCardLobsterBrowser: 'Caisra',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in Caisra',
    ...
    // Caisra
    cowork: 'Caisra',
    coworkSettings: 'Caisra Settings',
    ...
    coworkWorkingDirectoryHint: 'Caisra will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for Caisra...',
    coworkSystemPromptHint: "Optional system prompt to customize Caisra's behavior",
    ...
    coworkModelSettingsHint:
      'Caisra uses the current model and provider configuration from Model Settings.',
    ...
    coworkAgentEngineOpenClaw: 'Caisra engine (Default)',
    ...
    settingsSavedButOpenClawSyncFailed:
      'Settings were saved locally, but applying them to the running engine failed. Please save again or restart the engine.',
    ...
    coworkOpenClawInstall: 'Start the engine',
    coworkOpenClawRetryInstall: 'Retry Engine Startup',
    coworkOpenClawStart: 'Start the engine',
    ...
    coworkOpenClawErrorRepairHint:
      'Quick Repair backs up and rebuilds the engine config, then restarts the gateway. It resolves most startup failures and keeps chats, model settings, skills, and workspace files.',
    ...
    openClawRepairGatewayStateDesc:
      'Back up and rebuild the engine config, then restart the gateway.',
    openClawRepairConfirmTitle: 'Repair engine startup?',
    ...
    openClawRepairConfigApplyPendingError:
      'The engine is still applying configuration changes. Try repairing again shortly.',
    ...
    openClawDataBackupDesc:
      'Back up login state, task records, model settings, skills, memory, and engine state. Project folders are not included.',
    ...
    openClawDataBackupBlockingTitle: 'Backing up Caisra data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import Caisra data',
    openClawDataMigrationBlockingDesc:
    ...
    openClawDataMigrationConfirmTitle: 'Import Caisra data backup?',
    openClawDataMigrationConfirmDesc:
      'Importing replaces current app data, including login state, sessions, settings, skills, memory, and engine state.',
    openClawDataMigrationConfirmSafeDesc:
    ...
    coworkMemoryEnabledHint:
      'The engine automatically indexes MEMORY.md for long-term memory retrieval by the Agent.',
    ...
    coworkMemoryLegacyNotice: 'Caisra engine mode is active. This page only applies to Cowork.',
    ...
    coworkConfigSaveFailed: 'Failed to save Caisra settings. Please try again.',
    ...
    coworkPermissionDescription: 'Caisra is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'Caisra needs your input',
    ...
    coworkHomeTagline: "I'm Caisra, your all-in-one office agent",
    ...
    coworkGatewaySessionSyncTimeout:
      'The engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add Caisra to your antivirus allowlist.',
    ...
    coworkErrorModelSourceLobsterAIPlan: 'Caisra plan',
    ...
    // Skill Sync (engine)
    syncSkillsFromOpenClaw: 'Sync from the engine',
    skillsSyncTitle: 'New Skills Detected',
    skillsSyncFound: 'Detected {count} skill(s) available to sync from the engine:',
    skillsSyncNow: 'Sync Now',
    skillsSyncSkip: 'Not Now',
    skillsSyncLater: 'You can always sync later from the "Add" menu under "Sync from the engine".',
    ...
    dshSettingsTitle: 'DeepSeek Harness',
    dshSettingsDesc: 'Bundles DeepSeek\'s official open-source agent framework (dsh). Once enabled, Caisra\'s model provider configuration syncs into dsh automatically.',
    ...
    pluginsDesc: 'Install and manage engine plugins to extend functionality.',
    ...
    pluginsSourceOpenclaw: 'Engine',
    pluginsSyncTitle: 'New Plugins Detected',
    pluginsSyncDesc: 'Discover and sync plugins from the engine.',
    pluginsSyncButton: 'Discover Plugins',
    pluginsSyncing: 'Syncing plugins...',
    pluginsSyncFound: 'Detected {count} plugin(s) available to sync from the engine:',
    pluginsSyncNone: 'No new plugins found',
    pluginsSyncNow: 'Sync Now',
    pluginsSyncSkip: 'Not Now',
    pluginsSyncLater:
      'You can always sync later from the "Install Plugin" dialog under the Engine tab.',
    ...
    imWeixinQrAccountMissing:
      'WeChat is already connected to this engine, but no local account ID was found. Refresh status and try again.',
    ...
    browserProfileManagedDescription:
      'Caisra starts a dedicated browser that is stable and clean.',
    ...
    browserDiagnosticGatewayReady: 'The engine is running',
    browserDiagnosticGatewayNotRunning: 'The engine is not running',
    browserDiagnosticGatewayFailed: 'Engine check failed',
    ...
    browserFollowGlobalProxyDescription:
      'Enabled by default. Turning it off is stored for Caisra, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'Caisra will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means Caisra will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means Caisra can open this domain',
    ...
    notificationSystemPermissionHint:
      'If you are not receiving notifications, allow Caisra to send notifications in the system settings.',
    ...
    usageAnalyticsEnabled: 'Help improve Caisra',
    usageAnalyticsEnabledDescription:
    ...
    welcomeAgreementLinkText: 'Caisra Terms of Service',
    welcomeCopyright: '© {year} Caisra',
