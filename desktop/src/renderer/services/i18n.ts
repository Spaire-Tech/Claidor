...
const translations: Record<'en', Record<string, string>> = {
  en: {
    ...
    matiesOnboardingVoiceStop: 'Stop',
    matiesOnboardingVoiceLoading: 'Loading the voice',
    matiesOnboardingVoiceConciseName: 'Concise',
    matiesOnboardingVoiceConciseLine: 'Minimal voices that say only what matters.',
    matiesOnboardingVoiceConciseSample: 'Report is done, it is in your folder. Two of the numbers looked off, so I marked them. Want me to find out where they came from?',
    ...
    matiesOnboardingVoiceBalancedSample: 'Hey, I finished the report and saved it to your folder. Two of the numbers looked a little off to me, so I have marked them rather than change anything. Want me to go back through the source and see where they came from?',
    matiesOnboardingVoiceWarmName: 'Warm',
    matiesOnboardingVoiceWarmLine: 'Encouraging voices that reassure and keep you moving.',
    matiesOnboardingVoiceWarmSample: 'Hey, good news. The report is done and it is sitting in your folder waiting for you. A couple of the numbers looked a bit strange, so I flagged them for you rather than guess. Want me to take another look before you send it anywhere?',
    matiesOnboardingVoiceDirectName: 'Direct',
    matiesOnboardingVoiceDirectLine: 'Decisive voices that get to the point and stop.',
    matiesOnboardingVoiceDirectSample: 'Report is done and saved to your folder. Rows twelve and forty need checking before this goes anywhere. Say the word and I will chase them down now.',
    matiesOnboardingVoiceSassyName: 'Sassy',
    matiesOnboardingVoiceSassyLine: 'Playful voices with a little bite to them.',
    matiesOnboardingVoiceSassySample: 'Right, the report is done, and yes, it is already in your folder. Two of the numbers were being a bit dramatic, so I flagged them rather than let them embarrass you. Want me to go and have a word with them?',
    ...
    skillsEmptySentence: 'No skills of your own yet. Add one from a folder or a link, or write one in a chat.',
    connectorsEmptySentence: 'No servers of your own yet.',
    ...
    aiSkin: 'AI skin',
    aiSkinStarterPrompt:
      'Create a custom appearance for Maties using {primary and accent colors} as the palette, centered on {theme or character}, set in {scene and mood}, and designed for {use case or purpose}. Generate a coordinated backdrop, emblem, and interface colors from this idea, then apply them to Maties.',
    ...
    aiSkinCreationGuide: 'Describe the look you want and Maties will design it.',
    ...
    aiSkinDeleteManagedCopyNote: 'Only Maties-managed skin copies are removed. The original images in the conversation are kept.',
    ...
    backgroundWorkEnabled: 'Keep working in the background',
    backgroundWorkEnabledDescription:
      'Once an hour it checks the things you asked it to watch and tells you the moment something changes. Off, it works only while you are talking to it.',
    dataBackupTitle: 'Back up your data',
    dataBackupDescription:
      'Save your chats, tasks, skills, memory and settings to one file. Your project folders are not included.',
    dataBackupAction: 'Back up',
    dataRestoreTitle: 'Move from another computer',
    dataRestoreDescription:
      'Open a backup file made on another computer. It replaces what is on this one, and Maties restarts to finish.',
    dataRestoreAction: 'Open a backup',
    coworkMemoryTitle: 'Memory',
    memoryRemembersTitle: 'What it remembers about you',
    memoryTidyingGroup: 'Tidying up',
    memoryTidyingTitle: 'Tidy up on its own',
    memoryTidyingDescription:
      'On its own clock it reads the day\u2019s notes, keeps what matters about you and your work, and drops the rest.',
    memoryTidyingWhen: 'When',
    memoryTidyingKeptToday: 'Kept {count} new notes today.',
    memorySearchGroup: 'How memory is searched',
    ...
    coworkAppPicker: 'Look in an app',
    coworkAppPickerHint: 'Where to look first. It can still use your other apps.',
    coworkAppPickerClear: 'Clear the app',
    ...
    myAgentSidebarTaskCount: '{count} conversations',
    ...
    // Skills
    skills: 'Skills',
    // « Connectors » was the old word. You do not acquire Gmail from us — you
    // already own it — so the tab is called Apps.
    apps: 'Apps',
    appsChannelsTitle: 'Where it answers',
    useSkill: 'Use Skill',
    ...
    matiesConnectionsBrowserSignIn: 'Sign in to {name} in your Maty\'s own browser',
    matiesConnectionsBrowserSignInOnce: '— once, and it stays signed in.',
    matiesConnectionsBrowserSignInFailed: '— it did not open just now.',
