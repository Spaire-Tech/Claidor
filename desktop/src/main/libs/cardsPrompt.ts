  ...
  const generated = generateSystemPrompt({
    ...
    promptOptions: {
      ...
      additionalRules: [
        ...
        'An image argument must be a real https URL you have actually seen in a page or a tool result in this conversation. Never invent, guess or "typical" one. No image is better than a wrong one; leave the argument out.',
