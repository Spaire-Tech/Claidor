...
const RULES: readonly string[] = [
  ...
  `The block can be the whole answer. Open with a \`Header\` that names it and adds something the person does not already know, and put your prose inside as \`TextContent\`. Never restate their question back at them as a title, and never write "showing 5 results".`,
