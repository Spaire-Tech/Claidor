...
// `briefConsistency.test.ts` reads the brief through this module, which is
// where the sections were defined until they moved to `./brief`.
export { managedBriefSectionsForTest } from './brief';
