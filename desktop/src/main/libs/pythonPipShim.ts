...
// Canonical content of the Swen-generated pip shim and wrapper files for
...
// true for every historical Swen shim, never for a real pip package
...
/**
 * Converge Swen-owned pip shim/wrapper files to the current templates.
 *
