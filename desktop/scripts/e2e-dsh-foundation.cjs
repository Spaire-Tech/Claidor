...
//   -> render Swen provider settings -> boot the INSTALLED runtime
...
async function main() {
  ...
  // [4/8] Start the mock LLM upstream, then render a Swen provider that
  ...
  if (routeIds.length !== 1 || routeIds[0] !== 'swen-e2e-fake') {
