...
This guide walks through testing the entire Web Search Skill integration with Caisra.

## Prerequisites

1. Caisra built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with Caisra.

**Steps:**

1. Start Caisra in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of Caisra launch.
...
1. Open a terminal while Caisra is running
...
**Objective:** Verify graceful shutdown of services when Caisra quits.

**Steps:**

1. With Caisra running and searches completed, quit the application
...
1. Start Caisra (ensure headless is false in config)
...
- ✅ Server auto-starts with Caisra
