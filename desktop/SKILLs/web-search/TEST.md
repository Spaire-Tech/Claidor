...
This guide walks through testing the entire Web Search Skill integration with Swen.

## Prerequisites

1. Swen built and ready to run
2. Google Chrome installed
3. Internet connection available

## Test 1: Service Auto-Start

**Objective:** Verify that the Bridge Server starts automatically with Swen.

**Steps:**

1. Start Swen in development mode:
   ```bash
...
**Expected Result:** ✅ Bridge Server starts automatically within 3 seconds of Swen launch.
...
1. Open a terminal while Swen is running
...
**Objective:** Verify graceful shutdown of services when Swen quits.

**Steps:**

1. With Swen running and searches completed, quit the application
...
1. Start Swen (ensure headless is false in config)
