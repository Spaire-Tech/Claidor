...
Real-time web search capability for Maties using Playwright-controlled browser automation.

## Overview

The Web Search Skill enables Maties to perform live web searches using Google and Bing, with automatic fallback when one provider is unavailable. The skill uses Playwright to control a local Chrome browser instance, making all operations transparent and observable.
...
This skill is part of the Maties project. For issues or suggestions:
