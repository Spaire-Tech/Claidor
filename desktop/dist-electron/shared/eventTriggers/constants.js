...
exports.EVENT_TRIGGER_MAX_BODY_BYTES = exports.EVENT_TRIGGER_SESSION_PREFIX = exports.EVENT_TRIGGER_TOKEN_FILE = exports.EVENT_TRIGGER_PATH = void 0;
exports.eventTriggerConfig = eventTriggerConfig;
exports.eventTriggerUrl = eventTriggerUrl;
exports.eventTriggerExample = eventTriggerExample;
/** The path the gateway serves the hooks endpoint on. */
exports.EVENT_TRIGGER_PATH = '/hooks';
/** The file in the engine state directory holding the shared token. */
exports.EVENT_TRIGGER_TOKEN_FILE = 'hook-token';
/**
 ...
 */
exports.EVENT_TRIGGER_SESSION_PREFIX = 'hook:';
/**
 ...
 * this path is big.
 */
exports.EVENT_TRIGGER_MAX_BODY_BYTES = 256 * 1024;
function eventTriggerConfig(token) {
    return {
        enabled: true,
        token,
        path: exports.EVENT_TRIGGER_PATH,
        // A caller does not get to choose which conversation it lands in.
        allowRequestSessionKey: false,
        allowedSessionKeyPrefixes: [exports.EVENT_TRIGGER_SESSION_PREFIX],
        maxBodyBytes: exports.EVENT_TRIGGER_MAX_BODY_BYTES,
    };
}
/** Where a local automation posts to, once the gateway port is known. */
function eventTriggerUrl(port) {
    return `http://127.0.0.1:${port}${exports.EVENT_TRIGGER_PATH}`;
}
/**
 ...
 */
function eventTriggerExample(port, token) {
    return [
