...
exports.SOMETHING_ELSE_ALTERNATES = exports.STARTER_TEAMS = exports.STRONGS = void 0;
exports.strongBySlug = strongBySlug;
/**
...
function strongBySlug(slug) {
    return exports.STRONGS.find(one => one.slug === slug);
}
/**
...
exports.SOMETHING_ELSE_ALTERNATES = [
    'projects-manager',
    'follow-through-agent',
    'office-ops-desk',
    'cooper',
];
//# sourceMappingURL=strongs.js.map