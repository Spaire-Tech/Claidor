...
exports.isPlanImplementationApproval = exports.containsPlanModePrompt = exports.PLAN_MODE_EXECUTION_OVERRIDE_MARKER = exports.PLAN_MODE_PROMPT_MARKER = void 0;
exports.PLAN_MODE_PROMPT_MARKER = '# Plan Mode';
exports.PLAN_MODE_EXECUTION_OVERRIDE_MARKER = '# Plan Mode Execution Override';
const containsPlanModePrompt = (systemPrompt) => Boolean(systemPrompt && /(?:^|\n)# Plan Mode(?:\r?\n|$)/.test(systemPrompt));
exports.containsPlanModePrompt = containsPlanModePrompt;
const isPlanImplementationApproval = (prompt) => {
...
exports.isPlanImplementationApproval = isPlanImplementationApproval;
