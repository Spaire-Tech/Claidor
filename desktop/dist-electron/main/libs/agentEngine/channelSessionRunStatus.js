...
exports.resolveChannelSessionTerminalStatus = resolveChannelSessionTerminalStatus;
exports.resolveChannelSessionNextStatus = resolveChannelSessionNextStatus;
function resolveChannelSessionTerminalStatus(rawStatus) {
    if (rawStatus === 'failed' ||
        rawStatus === 'killed' ||
        rawStatus === 'timeout' ||
        rawStatus === 'error') {
 ...
 */
function resolveChannelSessionNextStatus(input) {
...
//# sourceMappingURL=channelSessionRunStatus.js.map