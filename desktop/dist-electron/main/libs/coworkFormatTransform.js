...
exports.normalizeProviderApiFormat = normalizeProviderApiFormat;
...
exports.buildOpenAIChatCompletionsURL = buildOpenAIChatCompletionsURL;
...
function normalizeProviderApiFormat(format) {
    if (format === 'openai') {
        return 'openai';
    }
    return 'anthropic';
...
function convertMessageToOpenAI(role, content) {
    ...
    for (const block of blocks) {
        ...
        if (blockType === 'tool_use') {
            ...
            let extraContent = blockObj.extra_content;
...
function openAIToAnthropic(body) {
    ...
    for (const toolCall of toolCalls) {
        ...
        let extraContent = toolCallObj.extra_content;
        if (extraContent === undefined) {
    ...
    return {
        ...
        stop_reason: mapStopReason(typeof firstChoice.finish_reason === 'string' ? firstChoice.finish_reason : null),
        stop_sequence: null,
        usage: {
...
//# sourceMappingURL=coworkFormatTransform.js.map