...
exports.UPSTREAM_PHRASES_DROPPED = exports.UPSTREAM_SECTIONS_DROPPED = void 0;
exports.pruneUpstreamBrief = pruneUpstreamBrief;
/**
 ...
 */
exports.UPSTREAM_SECTIONS_DROPPED = [
...
exports.UPSTREAM_PHRASES_DROPPED = [
 ...
 */
function pruneUpstreamBrief(content) {
    const dropped = new Set(exports.UPSTREAM_SECTIONS_DROPPED.map(one => one.heading));
    ...
    for (const line of lines) {
        if (HEADING.test(line)) {
            ...
            if (skippingAtDepth && depth <= skippingAtDepth)
                skippingAtDepth = 0;
...
//# sourceMappingURL=upstreamBrief.js.map