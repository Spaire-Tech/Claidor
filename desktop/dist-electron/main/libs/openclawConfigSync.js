...
exports.OpenClawConfigSync = exports.findInvalidKimiK3ServerTransports = exports.sanitizeModelCustomParams = exports.finalizeModelCompatibilityOwners = exports.buildProviderSelection = exports.managedBriefSectionsForTest = exports.OPENCLAW_BINDING_ANY_ACCOUNT_ID = exports.modelCompatConfigChangeRequiresRestart = exports.OPENCLAW_HEARTBEAT_EVERY_DISABLED = exports.OPENCLAW_HEARTBEAT_EVERY_ENABLED = exports.OPENCLAW_LOBSTERAI_MODEL_TIMEOUT_SECONDS = exports.OPENCLAW_BOOTSTRAP_TOTAL_MAX_CHARS = exports.OPENCLAW_BOOTSTRAP_MAX_CHARS = exports.OPENCLAW_AGENT_TIMEOUT_SECONDS = void 0;
exports.omitPluginIndexManagedKeys = omitPluginIndexManagedKeys;
exports.resolveModelSourceForOpenClawProvider = resolveModelSourceForOpenClawProvider;
...
const avatars_1 = require("../../shared/agent/avatars");
const chiefOfStaff_1 = require("../../shared/agent/chiefOfStaff");
const constants_1 = require("../../shared/askInput/constants");
const constants_2 = require("../../shared/browserCredentials/constants");
const constants_3 = require("../../shared/browserWebAccess/constants");
const proposal_1 = require("../../shared/connections/proposal");
const constants_4 = require("../../shared/cowork/constants");
const errorDetail_1 = require("../../shared/cowork/errorDetail");
const constants_5 = require("../../shared/eventTriggers/constants");
const url_1 = require("../../shared/mcp/url");
const constants_6 = require("../../shared/openclawEngine/constants");
const constants_7 = require("../../shared/openclawTranscript/constants");
const constants_8 = require("../../shared/projects/constants");
...
const appUiMap_1 = require("../../shared/settings/appUiMap");
const constants_9 = require("../../shared/settings/constants");
const constants_10 = require("../../shared/staffing/constants");
const roster_1 = require("../../shared/staffing/roster");
const appConstants_1 = require("../appConstants");
const logger_1 = require("../logger");
const constants_11 = require("../openclawSessionPolicy/constants");
const store_1 = require("../openclawSessionPolicy/store");
const agentModelRoles_1 = require("./agentModelRoles");
const artifactsPrompt_1 = require("./artifactsPrompt");
const cardsPrompt_1 = require("./cardsPrompt");
const claudeCodeCli_1 = require("./claudeCodeCli");
const claudeSettings_1 = require("./claudeSettings");
const composioApi_1 = require("./composio/composioApi");
const coworkOpenAICompatProxy_1 = require("./coworkOpenAICompatProxy");
const openclawAgentModels_1 = require("./openclawAgentModels");
const openclawChannelSessionSync_1 = require("./openclawChannelSessionSync");
const openclawConfigImpact_1 = require("./openclawConfigImpact");
const openclawHeartbeatRepair_1 = require("./openclawHeartbeatRepair");
const openclawMemoryFile_1 = require("./openclawMemoryFile");
const openclawModelCatalog_1 = require("./openclawModelCatalog");
const whenThingsFail_1 = require("./whenThingsFail");
const gwDiagTs = () => {
    const d = new Date();
...
const upstreamBrief_1 = require("./upstreamBrief");
const mapExecutionModeToSandboxMode = (mode, isEnterprise) => {
    if (!isEnterprise)
        return 'off';
    switch (mode) {
        case 'sandbox':
 ...
 */
function omitPluginIndexManagedKeys(plugins) {
    if (typeof plugins !== 'object' || plugins === null || Array.isArray(plugins)) {
        return {};
    }
    const managedKeys = constants_6.OPENCLAW_PLUGIN_INDEX_MANAGED_KEYS;
 ...
 */
exports.OPENCLAW_AGENT_TIMEOUT_SECONDS = 3600;
/**
 ...
 */
exports.OPENCLAW_BOOTSTRAP_MAX_CHARS = 120_000;
exports.OPENCLAW_BOOTSTRAP_TOTAL_MAX_CHARS = 200_000;
exports.OPENCLAW_LOBSTERAI_MODEL_TIMEOUT_SECONDS = 330;
exports.OPENCLAW_HEARTBEAT_EVERY_ENABLED = '1h';
exports.OPENCLAW_HEARTBEAT_EVERY_DISABLED = '0m';
...
const asConfigRecord = (value) => (value !== null && typeof value === 'object' && !Array.isArray(value)
    ? value
    : undefined);
const buildModelCompatRestartFingerprint = (config) => {
    ...
    const ownerProviderIds = Object.entries(providers ?? {})
        .filter(([, value]) => (asConfigRecord(value)?.api === OPENCLAW_MODEL_COMPAT_PLUGIN_ID))
    ...
    const sortedModelProfiles = Object.fromEntries(Object.entries(modelProfiles ?? {}).sort(([left], [right]) => left.localeCompare(right)));
    const thinkingProfiles = asConfigRecord(compatConfig?.thinkingProfiles);
    const sortedThinkingProfiles = Object.fromEntries(Object.entries(thinkingProfiles ?? {}).sort(([left], [right]) => left.localeCompare(right)));
...
const modelCompatConfigChangeRequiresRestart = (previousConfig, nextConfig) => (buildModelCompatRestartFingerprint(previousConfig)
    !== buildModelCompatRestartFingerprint(nextConfig));
exports.modelCompatConfigChangeRequiresRestart = modelCompatConfigChangeRequiresRestart;
exports.OPENCLAW_BINDING_ANY_ACCOUNT_ID = '*';
...
function deriveNimAccountId(instance) {
...
function deriveNimAccountConfigKey(instance) {
    if (instance.instanceId?.trim()) {
        return instance.instanceId.trim().slice(0, 8);
    }
    return deriveNimAccountId(instance);
}
function hasNimRuntimeCredentials(instance) {
    return Boolean((instance.nimToken && instance.nimToken.trim()) ||
        (instance.appKey && instance.account && instance.token));
}
function isEnabledNimRuntimeInstance(instance) {
    return Boolean(instance.enabled && hasNimRuntimeCredentials(instance));
}
function shouldUseOpenAIResponsesApi(providerName, baseURL) {
...
const mapApiTypeToOpenClawApi = (apiType, providerName, baseURL) => {
 ...
 */
const isDashScopeUrl = (url) => !!url && /dashscope\.aliyuncs\.com/i.test(url);
/**
 ...
 */
const rewriteDashScopeAnthropicToOpenAI = (url) => {
...
const normalizeModelName = (modelId) => {
 ...
 */
const resolveModelDisplayName = (modelId, userModelName) => {
...
const MANAGED_TOOL_DENY = ['web_search'];
/**
 ...
 */
const providerApiKeyEnvVar = (providerName) => {
...
const MANAGED_BROWSER_POLICY_PROMPT = [
    ...
    `- When a page requires a password and \`${constants_2.BrowserCredentialMcpServer.ModelToolName}\` is available, call it before asking the user to sign in manually. The tool can use an encrypted saved login without revealing its password to you.`,
 ...
 */
const buildManagedPersonPrompt = (workType) => {
...
const buildManagedProjectsPrompt = (projects) => {
 ...
 */
const buildManagedAppUiPrompt = (mapPath, failurePath) => [
...
const MANAGED_EXEC_SAFETY_PROMPT = [
    ...
    `- Never ask the person to type a password, an API key, a one-time code or a card number as a chat message. Call \`${constants_1.ASK_INPUT_TOOL}\` instead. It draws a card with masked boxes, and what they type comes back to you without ever entering the conversation.`,
 ...
 */
const resolveSkillCreationPath = () => {
    const skillsDir = path_1.default.join(electron_1.app.getPath('userData'), 'SKILLs');
    const home = electron_1.app.getPath('home');
    const prefix = home.endsWith(path_1.default.sep) ? home : home + path_1.default.sep;
    const compacted = skillsDir.startsWith(prefix)
        ? '~/' + skillsDir.slice(prefix.length)
        : skillsDir;
    return compacted.replace(/\\/g, '/');
};
const buildManagedSkillCreationPrompt = (skillsDirPath) => [
    '## Skill Creation',
    '',
...
const MANAGED_DELIVERABLE_LINKS_PROMPT = [
    ...
    `- Keep intermediate files (helper scripts, scratch data, drafts) inside the \`${constants_4.COWORK_TEMP_DIR_NAME}/\``,
    '  directory under the session working directory, and do not link them in the final reply.',
    `- The user can clean up \`${constants_4.COWORK_TEMP_DIR_NAME}/\` at any time;`,
 ...
 */
const managedBriefSectionsForTest = () => [
...
exports.managedBriefSectionsForTest = managedBriefSectionsForTest;
...
const stripTemplateFrontMatter = (content) => {
...
const resolveBundledOpenClawAgentsTemplatePaths = () => {
    const runtimeRoots = electron_1.app.isPackaged === true
    ...
    return runtimeRoots.map(runtimeRoot => path_1.default.join(runtimeRoot, 'docs', 'reference', 'templates', 'AGENTS.md'));
};
const readBundledOpenClawAgentsTemplate = () => {
    for (const templatePath of resolveBundledOpenClawAgentsTemplatePaths()) {
        try {
            ...
            if (trimmed) {
                ...
                return (0, openclawHeartbeatRepair_1.stripProactiveHeartbeatSection)(trimmed);
            }
        }
        catch {
...
const sessionSnapshotContainsDisabledManagedSkill = (entry) => {
...
const buildOpenClawThinkingRuntimeConfig = (thinkingConfig) => {
    if (!thinkingConfig)
        return undefined;
    const configuredLevels = new Set(thinkingConfig.options.map(option => option.openclawLevel));
    return {
        thinkingLevelMap: Object.fromEntries(OPENCLAW_CONFIGURABLE_THINKING_LEVELS.map(level => [
            level,
...
const DASHSCOPE_EXPLICIT_CONTEXT_CACHE_PARAMS = {
    params: {
...
const ANTHROPIC_COMPATIBLE_EXPLICIT_CONTEXT_CACHE_PARAMS = {
    params: {
        cacheRetention: 'short',
...
const ANTHROPIC_EXPLICIT_CONTEXT_CACHE_PARAMS = {
    params: {
        cacheRetention: 'short',
    },
};
...
const normalizeBaseUrlPath = (rawBaseUrl, pathName) => {
 ...
 */
const stripChatCompletionsSuffix = (rawBaseUrl) => {
...
const isLoopbackProviderBaseUrl = (rawBaseUrl) => {
    try {
...
const shouldUseEnvProxyForProviderBaseUrl = (rawBaseUrl) => ((0, systemProxy_1.isSystemProxyEnabled)() && !isLoopbackProviderBaseUrl(rawBaseUrl));
const normalizeGeminiBaseUrl = (rawBaseUrl) => {
...
const resolveDeepSeekModelReasoning = (modelId) => {
...
const isPositiveModelLimit = (value) => typeof value === 'number' && Number.isFinite(value) && value > 0;
const clampModelMaxTokens = (rawMaxTokens, contextWindow) => {
...
const resolveCatalogModelMaxTokens = (providerId, modelId, sessionModelId) => {
    ...
    for (const candidateModelId of candidateModelIds) {
        const maxTokens = (0, openclawModelCatalog_1.resolveOpenClawCatalogModelMaxTokens)(providerId, candidateModelId);
...
const resolveModelMaxTokensForOpenClaw = (options) => {
    const catalogMaxTokens = options.api === providers_1.OpenClawApi.AnthropicMessages
        ? resolveCatalogModelMaxTokens(options.descriptor.providerId, options.modelId, options.sessionModelId)
        : undefined;
    const rawMaxTokens = options.maxTokens
        ?? catalogMaxTokens
        ?? options.descriptor.modelDefaults?.maxTokens
        ?? (options.api === providers_1.OpenClawApi.AnthropicMessages
            ? OPENCLAW_DEFAULT_MODEL_MAX_TOKENS
            : undefined);
    return clampModelMaxTokens(rawMaxTokens, options.contextWindow);
};
const PROVIDER_REGISTRY = {
    [providers_1.ProviderName.LobsteraiServer]: {
        providerId: providers_1.OpenClawProviderId.LobsteraiServer,
    ...
    [providers_1.ProviderName.Moonshot]: {
        providerId: providers_1.OpenClawProviderId.Moonshot,
        resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
    ...
    [providers_1.ProviderName.Gemini]: {
        providerId: providers_1.OpenClawProviderId.Google,
        resolveApi: () => providers_1.OpenClawApi.GoogleGenerativeAI,
        normalizeBaseUrl: normalizeGeminiBaseUrl,
        modelDefaults: {
            reasoning: true,
        },
    },
    [providers_1.ProviderName.Xai]: {
        providerId: providers_1.OpenClawProviderId.Xai,
        ...
        resolveApi: () => providers_1.OpenClawApi.OpenAIResponses,
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    ...
    [`${providers_1.ProviderName.Xai}:oauth`]: {
        providerId: providers_1.OpenClawProviderId.Xai,
        resolveApi: () => providers_1.OpenClawApi.OpenAIResponses,
        normalizeBaseUrl: () => XAI_BASE_URL,
        resolveApiKey: () => undefined,
    },
    [providers_1.ProviderName.Anthropic]: {
        providerId: providers_1.OpenClawProviderId.Anthropic,
        resolveApi: () => providers_1.OpenClawApi.AnthropicMessages,
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [providers_1.ProviderName.OpenAI]: {
        providerId: providers_1.OpenClawProviderId.OpenAI,
        resolveApi: ({ baseURL }) => shouldUseOpenAIResponsesApi(providers_1.ProviderName.OpenAI, baseURL)
            ? providers_1.OpenClawApi.OpenAIResponses
            : providers_1.OpenClawApi.OpenAICompletions,
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [`${providers_1.ProviderName.OpenAI}:oauth`]: {
        providerId: providers_1.OpenClawProviderId.OpenAI,
        resolveApi: () => providers_1.OpenClawApi.OpenAIChatGPTResponses,
        normalizeBaseUrl: () => OPENAI_CODEX_BASE_URL,
        resolveApiKey: () => undefined,
    },
    [providers_1.ProviderName.DeepSeek]: {
        providerId: providers_1.OpenClawProviderId.DeepSeek,
        resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
        normalizeBaseUrl: stripChatCompletionsSuffix,
        resolveModelReasoning: resolveDeepSeekModelReasoning,
    },
    [providers_1.ProviderName.Qwen]: {
        providerId: providers_1.OpenClawProviderId.Qwen,
        resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [providers_1.ProviderName.Zhipu]: {
        providerId: providers_1.OpenClawProviderId.Zai,
        resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [providers_1.ProviderName.Volcengine]: {
        providerId: providers_1.OpenClawProviderId.Volcengine,
        resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [providers_1.ProviderName.Minimax]: {
        providerId: providers_1.OpenClawProviderId.Minimax,
        resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [`${providers_1.ProviderName.Minimax}:oauth`]: {
        providerId: providers_1.OpenClawProviderId.MinimaxPortal,
        resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [providers_1.ProviderName.Youdaozhiyun]: {
        providerId: providers_1.OpenClawProviderId.Youdaozhiyun,
        resolveApi: () => providers_1.OpenClawApi.OpenAICompletions,
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [providers_1.ProviderName.StepFun]: {
        providerId: providers_1.OpenClawProviderId.StepFun,
        resolveApi: () => providers_1.OpenClawApi.OpenAICompletions,
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [providers_1.ProviderName.Xiaomi]: {
        providerId: providers_1.OpenClawProviderId.Xiaomi,
        resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
        normalizeBaseUrl: stripChatCompletionsSuffix,
        resolveModelReasoning: () => true,
    },
    [providers_1.ProviderName.OpenRouter]: {
        providerId: providers_1.OpenClawProviderId.OpenRouter,
        resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [providers_1.ProviderName.Ollama]: {
        providerId: providers_1.OpenClawProviderId.Ollama,
        resolveApi: () => providers_1.OpenClawApi.OpenAICompletions,
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [providers_1.ProviderName.LmStudio]: {
        providerId: providers_1.OpenClawProviderId.LmStudio,
        resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
        normalizeBaseUrl: stripChatCompletionsSuffix,
    },
    [providers_1.ProviderName.Copilot]: {
        providerId: providers_1.OpenClawProviderId.LobsteraiCopilot,
        resolveApi: () => providers_1.OpenClawApi.OpenAICompletions,
        normalizeBaseUrl: stripChatCompletionsSuffix,
        resolveRuntimeBaseUrl: () => {
            const proxyBase = (0, coworkOpenAICompatProxy_1.getCoworkOpenAICompatProxyBaseURL)('local');
...
const DEFAULT_DESCRIPTOR = {
    providerId: providers_1.OpenClawProviderId.Lobster,
    resolveApi: ({ apiType, baseURL }) => mapApiTypeToOpenClawApi(apiType, undefined, baseURL),
    normalizeBaseUrl: stripChatCompletionsSuffix,
};
const resolveDescriptor = (providerName, codingPlanEnabled, authType) => {
    if (providerName === providers_1.ProviderName.OpenAI && authType === 'oauth') {
        return PROVIDER_REGISTRY[`${providers_1.ProviderName.OpenAI}:oauth`];
    }
    if (providerName === providers_1.ProviderName.Minimax && authType === 'oauth') {
        return PROVIDER_REGISTRY[`${providers_1.ProviderName.Minimax}:oauth`];
    }
    if (providerName === providers_1.ProviderName.Xai && authType === 'oauth') {
        return PROVIDER_REGISTRY[`${providers_1.ProviderName.Xai}:oauth`];
    }
    ...
    return {
        ...DEFAULT_DESCRIPTOR,
        providerId: providerName || providers_1.OpenClawProviderId.Lobster,
    };
};
const buildProviderSelection = (options) => {
    ...
    const runtimeProfileSource = providerName === providers_1.ProviderName.LobsteraiServer
        ? providers_1.ModelRuntimeProfileSource.Server
        : CUSTOM_PROVIDER_NAME_PATTERN.test(providerName)
            ? providers_1.ModelRuntimeProfileSource.Custom
            : providers_1.ModelRuntimeProfileSource.BuiltIn;
    const runtimeProfile = (0, providers_1.resolveModelRuntimeProfile)({
    ...
    const runtimeProfileDefinition = runtimeProfile
        ? (0, providers_1.getModelRuntimeProfileDefinition)(runtimeProfile)
        : undefined;
    const thinkingRuntimeConfig = buildOpenClawThinkingRuntimeConfig(options.thinkingConfig);
    const resolvedSupportsImage = providers_1.ProviderRegistry.resolveModelSupportsImage(providerName, options.modelId, options.supportsImage);
    const resolvedSupportsVideo = providers_1.ProviderRegistry.resolveModelSupportsVideo(providerName, options.modelId, options.supportsVideo);
    const resolvedSupportsThinking = providers_1.ProviderRegistry.resolveModelSupportsThinking(providerName, options.modelId, options.supportsThinking);
    const modelInput = runtimeProfileDefinition
    ...
    const auth = ((options.providerName === providers_1.ProviderName.Minimax
        || options.providerName === providers_1.ProviderName.OpenAI
        || options.providerName === providers_1.ProviderName.Xai)
        && options.authType === 'oauth')
        ? providers_1.AuthType.OAuth
        : providers_1.AuthType.ApiKey;
    ...
    const contextWindow = runtimeProfileDefinition?.contextWindow
        ?? providers_1.ProviderRegistry.resolveModelContextWindow(providerName, options.modelId, options.contextWindow)
        ?? descriptor.modelDefaults?.contextWindow;
    const resolvedMaxTokens = runtimeProfileDefinition?.maxTokens
        ?? providers_1.ProviderRegistry.resolveModelMaxTokens(providerName, options.modelId, options.maxTokens);
    ...
    return {
        ...
        ...(runtimeProfile && runtimeProfileSource !== providers_1.ModelRuntimeProfileSource.BuiltIn
        ...
        providerConfig: {
            ...
            ...(apiKey ? { apiKey } : {}),
            auth,
            ...(descriptor.providerId === providers_1.OpenClawProviderId.LobsteraiServer
                ? { timeoutSeconds: exports.OPENCLAW_LOBSTERAI_MODEL_TIMEOUT_SECONDS }
                : {}),
            ...(request ? { request } : {}),
            models: [
                {
...
exports.buildProviderSelection = buildProviderSelection;
/**
 ...
 */
function resolveModelSourceForOpenClawProvider(openclawProviderId) {
    const providerId = openclawProviderId?.trim();
    if (!providerId)
        return undefined;
    if (providerId === providers_1.OpenClawProviderId.LobsteraiServer) {
        return {
            source: errorDetail_1.CoworkErrorModelSource.LobsterAIPlan,
            providerName: providers_1.ProviderName.LobsteraiServer,
        };
    }
    for (const entry of (0, claudeSettings_1.listProviderSourceEntries)()) {
        const descriptor = resolveDescriptor(entry.providerName, entry.codingPlanEnabled, entry.authType);
        if (descriptor.providerId !== providerId)
            continue;
        if (entry.providerName === providers_1.ProviderName.Custom) {
            return {
                source: errorDetail_1.CoworkErrorModelSource.CustomProvider,
        ...
        const providerDisplayName = entry.displayName || providers_1.ProviderRegistry.get(entry.providerName)?.label || undefined;
        if (entry.codingPlanEnabled) {
            return {
                source: errorDetail_1.CoworkErrorModelSource.CodingPlan,
                providerName: entry.providerName,
                providerDisplayName,
            };
        }
        return {
            source: entry.authType === 'oauth'
                ? errorDetail_1.CoworkErrorModelSource.BuiltinOAuth
                : errorDetail_1.CoworkErrorModelSource.BuiltinProvider,
            providerName: entry.providerName,
            providerDisplayName,
        };
    }
...
const buildProviderModelCatalog = (providers) => Object.fromEntries(Object.entries(providers).map(([providerId, providerConfig]) => [
    providerId,
    {
...
const cloneAgentModelDefault = (entry) => (entry.params ? { params: { ...entry.params } } : {});
const mergeAgentModelDefault = (current, next) => ({
    ...(current ?? {}),
    ...(next.params
        ? {
            params: {
...
const buildCompleteAgentModelDefaults = (providers, customDefaults) => {
    const modelDefaults = {};
...
const upsertProviderModel = (providerConfig, model) => {
...
const OPENCLAW_TRANSPORT_APIS = new Set([
    'anthropic-messages',
    'openai-completions',
    'openai-responses',
 ...
 */
const finalizeModelCompatibilityOwners = (providers, candidateProfiles) => {
    const acceptedProfiles = {};
    const rejectedModelRefs = [];
    const acceptedRefsByProvider = new Map();
    for (const [modelRef, profile] of Object.entries(candidateProfiles).sort(([a], [b]) => a.localeCompare(b))) {
        ...
        if (!provider
            || !model
            || profile !== providers_1.ModelRuntimeProfile.MoonshotKimiK3
            || model.api !== providers_1.OpenClawApi.OpenAICompletions) {
    ...
    for (const [providerId, refs] of acceptedRefsByProvider) {
        ...
        const hasExplicitTransportApis = provider.models.every(model => OPENCLAW_TRANSPORT_APIS.has(model.api));
    ...
    return {
        modelProfiles: Object.fromEntries(Object.entries(acceptedProfiles).sort(([a], [b]) => a.localeCompare(b))),
        rejectedModelRefs: Array.from(new Set(rejectedModelRefs)).sort(),
    };
};
exports.finalizeModelCompatibilityOwners = finalizeModelCompatibilityOwners;
const sanitizeModelCustomParams = (customParams, runtimeProfile) => {
    if (runtimeProfile !== providers_1.ModelRuntimeProfile.MoonshotKimiK3) {
        return { customParams: { ...customParams }, removedKeys: [] };
    }
    const removedKeys = (0, providers_1.findKimiK3ReservedCustomParamKeys)(customParams);
    if (removedKeys.length === 0) {
        return { customParams: { ...customParams }, removedKeys };
    }
    const removedKeySet = new Set(removedKeys);
    return {
        customParams: Object.fromEntries(Object.entries(customParams).filter(([key]) => !removedKeySet.has(key))),
        removedKeys,
    };
};
exports.sanitizeModelCustomParams = sanitizeModelCustomParams;
const collectCompatibilityOwnerProfile = (profiles, selection) => {
    if (!selection.compatibilityOwnerProfile)
        return;
    profiles[selection.primaryModel] = selection.compatibilityOwnerProfile;
};
const collectThinkingProfile = (profiles, selection, thinkingConfig, requestCapabilities) => {
    if (!thinkingConfig)
        return;
    profiles[selection.primaryModel] = {
        options: thinkingConfig.options.map(option => ({ ...option })),
        defaultLevel: thinkingConfig.defaultLevel,
        ...((0, lobsterAIRequestOptions_1.supportsLobsterAIRequestOptionsV1)(requestCapabilities)
            ? { requestOptionsVersion: lobsterAIRequestOptions_1.LOBSTERAI_REQUEST_OPTIONS_VERSION }
            : {}),
    };
};
const findInvalidKimiK3ServerTransports = (serverModels) => (serverModels
    .filter(model => model.runtimeProfile === providers_1.ModelRuntimeProfile.MoonshotKimiK3)
    .map(model => ({
...
exports.findInvalidKimiK3ServerTransports = findInvalidKimiK3ServerTransports;
const normalizeServerApiType = (apiFormat) => (apiFormat === 'anthropic' ? 'anthropic' : 'openai');
const stripExplicitContextCacheProviderSuffix = (modelId, provider) => {
...
const normalizeExplicitContextCacheModelId = (modelId, provider) => {
...
const resolveExplicitContextCacheFamily = (modelId, provider) => {
...
const shouldApplyProviderExplicitContextCacheDefault = (providerName) => {
    const normalizedProvider = providerName?.trim();
    return normalizedProvider === providers_1.ProviderName.Anthropic
        || normalizedProvider === providers_1.ProviderName.Qwen
...
const resolveExplicitContextCacheDefault = (options) => {
    ...
    if (!enabled || family === null)
        return null;
    if (options.api === providers_1.OpenClawApi.OpenAICompletions) {
        return family === 'qwen'
            ? DASHSCOPE_EXPLICIT_CONTEXT_CACHE_PARAMS
            : ANTHROPIC_COMPATIBLE_EXPLICIT_CONTEXT_CACHE_PARAMS;
    }
    if (options.api === providers_1.OpenClawApi.AnthropicMessages) {
        return ANTHROPIC_EXPLICIT_CONTEXT_CACHE_PARAMS;
    }
    return null;
};
const addExplicitContextCacheDefault = (defaults, selection, source) => {
    ...
    console.info(`${EXPLICIT_CONTEXT_CACHE_LOG_PREFIX} [ExplicitCacheConfig] model=${selection.sessionModelId} api=${model.api} provider=${source.provider ?? selection.providerId} params=${JSON.stringify(contextCacheDefault.params ?? {})}`);
};
const readPreinstalledPluginIds = () => {
    try {
...
const readPreinstalledPlugins = () => (readPreinstalledPluginIds()
    .map((packageId) => {
    const pluginId = (0, openclawLocalExtensions_1.resolveOpenClawExtensionPluginId)(packageId);
    return pluginId ? { packageId, pluginId } : null;
})
    .filter((plugin) => plugin !== null));
const pluginMatches = (plugin, ...ids) => ids.includes(plugin.packageId) || ids.includes(plugin.pluginId);
const isBundledPluginAvailable = (pluginId) => {
    return (0, openclawLocalExtensions_1.hasBundledOpenClawExtension)(pluginId);
};
...
function safeServerKey(name) {
    if (!MCP_NAME_NON_ASCII_RE.test(name))
        return name;
    const hash = (0, crypto_1.createHash)('md5').update(name).digest('hex').slice(0, 8);
    return `mcp-${hash}`;
}
function buildOpenClawMcpServers(servers) {
    const result = {};
    for (const server of servers) {
        const entry = {};
        let normalizedRemoteUrl = '';
        if (server.transportType !== 'stdio') {
            const normalizedUrl = (0, url_1.normalizeMcpServerUrlInput)(server.url);
            if (!normalizedUrl.ok) {
        ...
        switch (server.transportType) {
            ...
            case 'http':
                ...
                if (server.auth === 'oauth') {
                    entry.auth = 'oauth';
                    if (server.oauthScope)
                        entry.oauth = { scope: server.oauthScope };
                }
                break;
        }
...
const buildStreamingModeConfig = (mode) => ({
    mode,
});
const buildManagedBrowserProxyExtraArgs = (browserWebAccess) => {
    if (!(0, systemProxy_1.isSystemProxyEnabled)()
        || !browserWebAccess.followGlobalProxy
        || browserWebAccess.networkMode !== constants_3.BrowserNetworkMode.ProxyCompatible) {
        return [];
    }
    const proxyUrl = (0, systemProxy_1.getActiveSystemProxyUrl)()?.trim();
...
class OpenClawConfigSync {
    ...
    getClaudeCodeMode;
    getOnboardingWorkType;
    getExecPolicy;
    previousBindingsJson;
    currentBindingsObj = {};
    constructor(deps) {
        this.engineManager = deps.engineManager;
        this.getCoworkConfig = deps.getCoworkConfig;
        this.getExecPolicy = deps.getExecPolicy ?? (() => constants_9.DEFAULT_EXEC_POLICY);
    ...
    buildSessionConfig() {
        const policy = this.getOpenClawSessionPolicy?.() ?? {
            keepAlive: constants_11.OpenClawSessionKeepAlive.ThirtyDays,
        };
        return (0, store_1.buildOpenClawSessionConfig)(policy);
    }
    buildBrowserConfig(browserWebAccess) {
        const allowedHostnames = (0, constants_3.normalizeBrowserHostnamePolicyList)(browserWebAccess.allowedHostnames);
        const blockedHostnames = (0, constants_3.normalizeBrowserHostnamePolicyList)(browserWebAccess.blockedHostnames);
        const extraArgs = buildManagedBrowserProxyExtraArgs(browserWebAccess);
        const ssrfPolicy = browserWebAccess.networkMode === constants_3.BrowserNetworkMode.Strict
            ? {
        ...
        if (browserWebAccess.displayMode === constants_3.BrowserDisplayMode.InApp) {
            const callbackUrl = this.getBrowserCallbackUrl?.();
            const mcpCommand = this.getLobsterBrowserMcpCommand?.();
            if (callbackUrl && mcpCommand) {
                console.log(`[EngineConfigSync] browser profile=${constants_3.BrowserRuntimeProfile.InApp} (the app's own panel)`);
                return {
                    ...commonConfig,
                    defaultProfile: constants_3.BrowserRuntimeProfile.InApp,
                    profiles: {
                        [constants_3.BrowserRuntimeProfile.InApp]: {
            ...
            // named neither piece.
            console.warn('[EngineConfigSync] in-app browser bridge unavailable, falling back to a separate browser window'
                + ` — callbackUrl=${callbackUrl ? 'ready' : 'null'}`
                + ` mcpCommand=${mcpCommand ? 'ready' : 'null'}`);
        }
        console.log(`[EngineConfigSync] browser profile=${constants_3.BrowserRuntimeProfile.Managed}`
            + ` (a separate window), displayMode=${browserWebAccess.displayMode}`);
        return {
            ...commonConfig,
            defaultProfile: constants_3.BrowserRuntimeProfile.Managed,
            headless: false,
            ...(extraArgs.length > 0 ? { extraArgs } : {}),
        };
    }
    buildWebToolsConfig(browserWebAccess, exec) {
    ...
    sync(reason) {
        ...
        const browserWebAccess = (0, constants_3.normalizeBrowserWebAccessConfig)(this.getBrowserWebAccessConfig());
        const serverModels = (0, claudeSettings_1.getAllServerModelMetadata)();
        ...
        const modelRoleRefs = (0, agentModelRoles_1.resolveAgentModelRoleRefs)(serverModels, providers_1.OpenClawProviderId.LobsteraiServer);
        const modelRoleDefaults = (0, agentModelRoles_1.buildAgentModelRoleDefaults)(modelRoleRefs);
        const invalidKimiK3Transports = (0, exports.findInvalidKimiK3ServerTransports)(serverModels);
        ...
        if (!apiResolution.config) {
            ...
            if (this.isEnterprise()) {
                console.log('[EngineConfigSync] enterprise mode: no API config resolved, generating full config with empty providers (enterprise merge will supply them)');
            }
            else {
                ...
                const mainWorkspacePath = (0, openclawMemoryFile_1.getMainAgentWorkspacePath)(this.engineManager.getStateDir());
        ...
        let allProvidersMap = {};
        const perModelCustomDefaults = {};
        const candidateModelProfiles = {};
        const candidateThinkingProfiles = {};
        let primaryModel = '';
        ...
        if (apiResolution.config) {
            ...
            providerSelection = (0, exports.buildProviderSelection)({
                apiKey,
                baseURL,
                modelId,
                apiType,
            ...
            collectThinkingProfile(candidateThinkingProfiles, providerSelection, apiResolution.providerMetadata?.thinkingConfig, apiResolution.providerMetadata?.requestCapabilities);
            primaryModel = providerSelection.primaryModel;
            if (providerSelection.providerId === providers_1.OpenClawProviderId.LobsteraiServer) {
                addExplicitContextCacheDefault(perModelCustomDefaults, providerSelection, {
                    modelId,
                });
            }
            for (const p of (0, claudeSettings_1.resolveAllEnabledProviderConfigs)()) {
                for (const m of p.models) {
                    const sel = (0, exports.buildProviderSelection)({
                        apiKey: p.apiKey,
                        baseURL: p.baseURL,
                        modelId: m.id,
                        apiType: p.apiType,
                    ...
                    if (m.customParams && Object.keys(m.customParams).length > 0) {
                        const sanitizedParams = (0, exports.sanitizeModelCustomParams)(m.customParams, sel.runtimeProfile);
                        if (sanitizedParams.removedKeys.length > 0) {
                            console.warn(`[EngineConfigSync] Ignored reserved Kimi K3 custom parameter keys for ${sel.primaryModel}: ${sanitizedParams.removedKeys.join(', ')}`);
                        }
                        if (Object.keys(sanitizedParams.customParams).length === 0) {
                            continue;
                        }
                        const modelKey = `${sel.providerId}/${sel.sessionModelId}`;
                        perModelCustomDefaults[modelKey] = mergeAgentModelDefault(perModelCustomDefaults[modelKey], { params: { extra_body: sanitizedParams.customParams } });
                    }
                }
            }
            if (!allProvidersMap[providerSelection.providerId]) {
                ...
                const alreadyHas = existing.models.some(em => em.id === providerSelection.providerConfig.models[0]?.id);
            ...
            const proxyPort = (0, openclawTokenProxy_1.getOpenClawTokenProxyPort)();
            if (proxyPort) {
                const providerId = providers_1.OpenClawProviderId.LobsteraiServer;
                if (serverModels.length > 0 || !allProvidersMap[providerId]) {
                    const firstServerModelId = serverModels[0]?.modelId || modelId;
                    const firstServerSel = (0, exports.buildProviderSelection)({
                    ...
                    collectThinkingProfile(candidateThinkingProfiles, firstServerSel, serverModels[0]?.thinkingConfig, serverModels[0]?.requestCapabilities);
                    ...
                    if (serverModels.length === 0) {
                        ...
                        for (const sm of serverModels) {
                            ...
                            const serverSel = (0, exports.buildProviderSelection)({
                                apiKey: 'proxy-managed',
                                baseURL: `http://127.0.0.1:${proxyPort}/v1`,
                                modelId: sm.modelId,
                            ...
                            collectThinkingProfile(candidateThinkingProfiles, serverSel, sm.thinkingConfig, sm.requestCapabilities);
        ...
        const finalizedCompatibility = (0, exports.finalizeModelCompatibilityOwners)(allProvidersMap, candidateModelProfiles);
        ...
        const finalizedThinkingProfiles = Object.fromEntries(Object.entries(candidateThinkingProfiles).sort(([left], [right]) => left.localeCompare(right)));
        ...
        if (claudeCode?.enabled) {
            primaryModel = (0, claudeCodeCli_1.claudeCliModelRef)(claudeCodeCli_1.CLAUDE_CODE_STRONG_MODEL);
            if (claudeCode.command) {
                cliBackends = { [claudeCodeCli_1.CLAUDE_CLI_PROVIDER]: { command: claudeCode.command } };
                console.log(`[EngineConfigSync] model=${primaryModel} through Claude Code at ${claudeCode.command}`);
            }
            else {
                console.warn(`[EngineConfigSync] model=${primaryModel} through Claude Code, but no \`claude\` command was found; `
                    + 'the engine will try a bare `claude` from its own PATH. Set CAISRA_CLAUDE_CLI to the binary if that fails.');
            }
        }
        console.log(`[EngineConfigSync] sandbox mode: ${sandboxMode} (executionMode: ${coworkConfig.executionMode || 'local'}, enterprise: ${this.isEnterprise()})`);
        const mainWorkspacePath = (0, openclawMemoryFile_1.getMainAgentWorkspacePath)(this.engineManager.getStateDir());
        const agents = this.getAgents?.() ?? [];
        const mainAgentWorkingDirectory = agents
            .find(agent => agent.id === agent_1.AgentId.Main)
            ?.workingDirectory
            ?.trim() || '';
        ...
        const hasPreinstalledPlugin = (...ids) => (preinstalledPlugins.some((plugin) => pluginMatches(plugin, ...ids)));
        ...
        const hasXaiPlugin = (0, openclawLocalExtensions_1.hasRuntimeBundledOpenClawExtension)('xai');
        const qwenPortalAuthPluginId = (0, openclawLocalExtensions_1.resolveOpenClawExtensionPluginId)('qwen-portal-auth');
        ...
        try {
            ...
            existingGateway = (existing.gateway ?? {});
        ...
        const existingPluginEntries = (existingPlugins.entries ?? {});
        ...
        const managedConfig = {
            ...
            agents: {
                defaults: {
                    timeoutSeconds: exports.OPENCLAW_AGENT_TIMEOUT_SECONDS,
                    ...
                    bootstrapMaxChars: exports.OPENCLAW_BOOTSTRAP_MAX_CHARS,
                    bootstrapTotalMaxChars: exports.OPENCLAW_BOOTSTRAP_TOTAL_MAX_CHARS,
                    model: {
                    ...
                    workspace: path_1.default.resolve(mainWorkspacePath),
                    mediaMaxMb: 30,
                    compaction: {
                        truncateAfterCompaction: true,
                        maxActiveTranscriptBytes: constants_7.OpenClawTranscriptSafetyLimit.SoftConfigValue,
                        ...modelRoleDefaults.compaction,
                    },
                    ...(taskWorkingDirectory ? { cwd: path_1.default.resolve(taskWorkingDirectory) } : {}),
                    memorySearch: {
                        enabled: true,
                    ...
                    heartbeat: {
                        every: coworkConfig.openClawHeartbeatEnabled === true
                            ? exports.OPENCLAW_HEARTBEAT_EVERY_ENABLED
                            : exports.OPENCLAW_HEARTBEAT_EVERY_DISABLED,
                        target: 'none',
                        lightContext: true,
                    ...
                    ...(lockToClaudeCode || Object.keys(agentModelDefaults).length > 0
                        ? {
                            models: {
                                ...agentModelDefaults,
                                ...(lockToClaudeCode
                                    ? Object.fromEntries(claudeCodeCli_1.CLAUDE_CODE_MODELS.map(model => [(0, claudeCodeCli_1.claudeCliModelRef)(model), {}]))
                                    : {}),
                            },
                        }
                        : {}),
            ...
            tools: this.buildWebToolsConfig(browserWebAccess, {
                mode: (0, constants_9.engineExecModeFor)(this.getExecPolicy()),
            ...
            cron: {
                enabled: true,
                store: path_1.default.join(this.engineManager.getStateDir(), 'cron', 'jobs.json'),
            ...
            ...((() => {
                ...
                const cleanedExistingEntries = Object.fromEntries(Object.entries(existingPluginEntries).filter(([id]) => (!knownStalePluginIds.includes(id) && !transientPluginIds.includes(id))));
                ...
                const pluginEntries = {
                    ...
                    ...Object.fromEntries(preinstalledPlugins.map(plugin => {
                        ...
                        const pluginEnabled = (() => {
                            ...
                            if (pluginMatches(plugin, 'openclaw-qqbot', 'qqbot'))
                                return qqbotPluginEnabled;
                            if (pluginMatches(plugin, 'discord'))
                                return discordPluginEnabled;
                            ...
                            if (pluginMatches(plugin, 'openclaw-netease-bee'))
                                return !!(neteaseBeeChanConfig?.enabled && neteaseBeeChanConfig.clientId && neteaseBeeChanConfig.secret);
                            if (pluginMatches(plugin, 'openclaw-weixin'))
                                return true; // Always keep enabled for QR login discovery
                    ...
                    ...(hasComposioPlugin
                        ? {
                            [COMPOSIO_PLUGIN_ID]: (0, openclawTokenProxy_1.getOpenClawTokenProxyPort)()
                                ? {
                                    enabled: true,
                                    config: { baseUrl: (0, composioApi_1.composioBaseUrlFor)((0, openclawTokenProxy_1.getOpenClawTokenProxyPort)()) },
                                }
                                : { enabled: false },
                        }
                        : {}),
                    ...
                    ...Object.fromEntries(userPlugins.map(p => [p.pluginId, {
                            enabled: p.enabled,
                ...
                return Object.keys(pluginEntries).length > 0
                    ? {
                        plugins: {
                            ...
                            ...((() => {
                                const paths = [
                                    (0, openclawLocalExtensions_1.findBundledExtensionsDir)(),
                                    (0, openclawLocalExtensions_1.findThirdPartyExtensionsDir)(),
                                ].filter((p) => p !== null);
        ...
        if (browserWebAccess.displayMode === constants_3.BrowserDisplayMode.InApp) {
            ...
            if (browserMcpLaunch) {
                nativeMcpServers[constants_2.BrowserCredentialMcpServer.Name] = {
                    command: browserMcpLaunch.command,
                    args: [...browserMcpLaunch.args, constants_2.BrowserCredentialMcpServer.ToolSetArgument],
                    ...(Object.keys(browserMcpLaunch.env).length > 0
                        ? { env: browserMcpLaunch.env }
                        : {}),
                    toolFilter: {
                        include: [constants_2.BrowserCredentialLoginTool.Name],
                    },
                };
            }
        }
        ...
        if (createAgentLaunch) {
            nativeMcpServers[constants_10.CREATE_AGENT_MCP_SERVER] = {
                ...
                toolFilter: { include: [constants_10.CREATE_AGENT_TOOL, roster_1.PROPOSE_TEAM_TOOL] },
            };
        }
        ...
        if (proposeConnectorLaunch) {
            nativeMcpServers[proposal_1.PROPOSE_CONNECTOR_MCP_SERVER] = {
                ...
                toolFilter: { include: [proposal_1.PROPOSE_CONNECTOR_TOOL] },
            };
        }
        ...
        if (hookToken) {
            managedConfig.hooks = {
                ...(0, constants_5.eventTriggerConfig)(hookToken),
                allowedSessionKeyPrefixes: [...(0, constants_5.eventTriggerConfig)(hookToken).allowedSessionKeyPrefixes],
            };
        }
        ...
        if (hasAskUserPlugin && askUserCallbackUrl && managedConfig.plugins) {
            const plugins = managedConfig.plugins;
        ...
        if (managedConfig.plugins) {
            ...
            const existingMemoryCoreConfig = existingMemoryCore.config;
            ...
            for (let idx = 0; idx < enabledTelegramInstances.length; idx++) {
                ...
                const account = {
                    ...
                    allowFrom: (() => {
                        ...
                        if (inst.dmPolicy === 'open' && !ids.includes('*'))
                            ids.push('*');
                        return ids;
                    })(),
                    ...
                    groupAllowFrom: (() => {
                        ...
                        if (inst.groupPolicy === 'open' && !ids.includes('*'))
                            ids.push('*');
                        return ids;
                    })(),
        ...
        if (enabledFeishuInstances.length > 0) {
            const buildFeishuAccountConfig = (inst, secretEnvVar) => ({
                enabled: true,
                name: inst.instanceName,
                appId: inst.appId,
            ...
            managedConfig.channels = { ...(managedConfig.channels || {}), feishu: { enabled: true, accounts } };
        }
        ...
        if (enabledDingTalkInstances.length > 0) {
            const buildDingTalkAccountConfig = (inst, secretEnvVar) => ({
                enabled: true,
                name: inst.instanceName,
            ...
            const dingtalkChannel = { enabled: true, accounts };
            managedConfig.channels = {
                ...(managedConfig.channels || {}),
        ...
        if (enabledQQInstances.length > 0) {
            const buildQQAccountConfig = (inst, secretEnvVar) => {
                const account = {
                    enabled: true,
                    name: inst.instanceName,
                    appId: inst.appId,
            ...
            managedConfig.channels = { ...(managedConfig.channels || {}), qqbot: { enabled: true, accounts } };
        }
        ...
        if (enabledPopoInstances.length > 0) {
            ...
            for (let idx = 0; idx < enabledPopoInstances.length; idx++) {
                ...
                const effectiveConnectionMode = inst.connectionMode || (inst.token ? 'webhook' : 'websocket');
            ...
            if (enabledInstances.length > 0) {
                ...
                for (const inst of enabledInstances) {
                    ...
                    if (inst.transport === 'imap') {
                        ...
                        if (inst.imapHost)
                            accountConfig.imapHost = inst.imapHost;
                        if (inst.imapPort)
                            accountConfig.imapPort = inst.imapPort;
                        if (inst.smtpHost)
                            accountConfig.smtpHost = inst.smtpHost;
                        if (inst.smtpPort)
                            accountConfig.smtpPort = inst.smtpPort;
                    }
        ...
        if (configuredNimInstances.length > 0) {
            ...
            configuredNimInstances.forEach((inst, idx) => {
                ...
                if (inst.p2p)
                    nimInstance.p2p = inst.p2p;
                if (inst.team)
                    nimInstance.team = inst.team;
                if (inst.qchat)
                    nimInstance.qchat = inst.qchat;
                if (inst.advanced)
                    nimInstance.advanced = inst.advanced;
            ...
            managedConfig.channels = { ...(managedConfig.channels || {}), nim: { accounts } };
        }
        // Sync NeteaseBee OpenClaw channel config (via openclaw-netease-bee plugin)
        if (neteaseBeeChanConfig?.enabled &&
        ...
        if (hasPreinstalledPlugin('openclaw-weixin')) {
            ...
            const weixinChannel = {
                ...
                allowFrom: (() => {
                    ...
                    if ((weixinConfig?.dmPolicy || 'open') === 'open' && !ids.includes('*'))
                        ids.push('*');
                    return ids;
                })(),
            };
        ...
        console.log('[EngineConfigSync] sync() managedConfig key fields:', {
            providers: managedConfig.models?.providers,
            primaryModel: managedConfig.agents?.defaults?.model,
        });
        let currentContent = '';
        try {
            currentContent = fs_1.default.readFileSync(configPath, 'utf8');
        }
        catch {
            currentContent = '';
        }
        ...
        const modelCompatRestartRequired = (() => {
            ...
            return (0, exports.modelCompatConfigChangeRequiresRestart)(previousConfig, JSON.parse(nextContent));
        })();
        let changedTopLevelKeys = [];
        if (configChanged) {
            ...
            try {
                ...
                fs_1.default.writeFileSync(tmpPath, stampedContent, 'utf8');
                fs_1.default.renameSync(tmpPath, configPath);
            }
            catch (error) {
                return {
                    ok: false,
        ...
        return {
            ...
            ...(changedTopLevelKeys.includes('mcp') || modelCompatRestartRequired
                ? { restartImpact: openclawConfigImpact_1.OpenClawConfigImpact.Restart }
                : {}),
    ...
    collectSecretEnvVars() {
        ...
        const allApiKeys = (0, claudeSettings_1.resolveAllProviderApiKeys)();
        ...
        env.LOBSTER_PROXY_TOKEN = (0, coworkOpenAICompatProxy_1.getCoworkOpenAICompatProxyToken)() || 'unconfigured';
        ...
        for (let idx = 0; idx < enabledTelegram.length; idx++) {
            ...
            if (idx === 0) {
                ...
                if (inst.webhookSecret)
                    env.LOBSTER_TG_WEBHOOK_SECRET = inst.webhookSecret;
            }
            else {
                env[`LOBSTER_TG_BOT_TOKEN_${idx}`] = inst.botToken;
                if (inst.webhookSecret)
                    env[`LOBSTER_TG_WEBHOOK_SECRET_${idx}`] = inst.webhookSecret;
            }
        }
        ...
        for (let idx = 0; idx < nimInstances.length; idx++) {
            ...
            if (inst.nimToken?.trim() || !inst.token)
                continue;
     ...
     * way.
     */
    syncExecApprovalPolicy() {
        const filePath = path_1.default.join(this.engineManager.getBaseDir(), '.openclaw', 'exec-approvals.json');
        let file;
        try {
            if (fs_1.default.existsSync(filePath)) {
                file = JSON.parse(fs_1.default.readFileSync(filePath, 'utf8'));
                if (file?.version !== 1)
                    file = { version: 1 };
            }
            else {
        ...
        const wanted = (0, constants_9.enginePolicyFor)(policy);
        const entries = [
            (file.defaults ??= {}),
            ...Object.values(file.agents),
        ];
        const stale = entries.filter(entry => entry.security !== wanted.security
        ...
        try {
            ...
            console.log(`[EngineConfigSync] set exec-approvals policy=${policy} `
    ...
    syncManagedSessionStore(selection, availableProviders) {
        const shouldMigrateManagedModelRefs = !(selection.providerId === 'lobster' && selection.sessionModelId === selection.legacyModelId);
        const fallbackTarget = (0, openclawAgentModels_1.parsePrimaryModelRef)(selection.primaryModel) ?? {
        ...
        if (!agentById.has(agent_1.AgentId.Main)) {
            agentById.set(agent_1.AgentId.Main, {
                id: agent_1.AgentId.Main,
                name: agent_1.DefaultAgentProfile.Name,
                description: '',
                systemPrompt: '',
                identity: '',
                model: '',
                ...
                avatar: (0, avatars_1.avatarFallback)(agent_1.AgentId.Main),
                label: '',
                voiceId: '',
                notify: true,
                createdAt: 0,
        ...
        for (const [agentId, agent] of agentById.entries()) {
            ...
            if (qualification.status === 'ambiguous') {
                console.warn(`[EngineConfigSync] Skipped ambiguous managed session model sync for "${agent.id}" because "${qualification.modelId}" matches multiple providers: ${qualification.providerIds.join(', ')}`);
            }
            const sessionStorePath = path_1.default.join(this.engineManager.getStateDir(), 'agents', agentId, 'sessions', 'sessions.json');
            let storeContent = '';
            try {
                storeContent = fs_1.default.readFileSync(sessionStorePath, 'utf8');
            }
            catch {
                continue;
            }
            let sessionStore;
            try {
                sessionStore = JSON.parse(storeContent);
            }
            catch {
                continue;
            }
            ...
            for (const [sessionKey, rawEntry] of Object.entries(sessionStore)) {
                ...
                if ((0, openclawChannelSessionSync_1.parseChannelSessionKey)(sessionKey) !== null) {
                ...
                const target = (0, openclawAgentModels_1.resolveManagedSessionModelTarget)({
            ...
            try {
                ...
                console.warn('[EngineConfigSync] Failed to update managed session store:', error instanceof Error ? error.message : String(error));
            }
        }
        return anyChanged;
    }
    ...
    resolveSkillsExtraDirs() {
        ...
        try {
            if (fs_1.default.statSync(userDataSkillsDir).isDirectory()) {
    ...
    buildSkillEntries() {
        ...
        for (const skill of skills) {
            ...
            if (existing && existing.enabled !== skill.enabled) {
                console.warn(`[EngineConfigSync] Skills with duplicate name "${skill.name}" disagree on enabled state; last one wins`);
            }
     ...
     */
    syncAgentsMd(workspaceDir, coworkConfig, agentId = agent_1.AgentId.Main) {
        const MARKER = constants_6.AGENTS_MD_MANAGED_MARKER;
        try {
            ensureDir(workspaceDir);
            const agentsMdPath = path_1.default.join(workspaceDir, 'AGENTS.md');
            this.syncAppUiMap(workspaceDir);
            // Build the managed section
            const sections = [];
            // Add system prompt if configured — strip MARKER to prevent content corruption
            const systemPrompt = (0, constants_6.stripAgentsMdManagedMarkers)((coworkConfig.systemPrompt || '').trim());
            if (systemPrompt) {
            ...
            if (agentId === agent_1.AgentId.Main) {
                sections.push(chiefOfStaff_1.CHIEF_OF_STAFF_BRIEF);
                const personPrompt = buildManagedPersonPrompt(this.getOnboardingWorkType());
                if (personPrompt)
                    sections.push(personPrompt);
            }
            ...
            sections.push((0, cardsPrompt_1.buildManagedCardsPrompt)());
            // And the two artifacts, a deck and a report, in OpenUI's own
            // libraries (`shared/artifacts/`).
            sections.push((0, artifactsPrompt_1.buildManagedArtifactsPrompt)());
            sections.push(buildManagedAppUiPrompt(appUiMap_1.APP_UI_MAP_PATH, whenThingsFail_1.WHEN_THINGS_FAIL_PATH));
            ...
            const scheduledTaskPrompt = (0, constants_6.stripAgentsMdManagedMarkers)((0, enginePrompt_1.buildScheduledTaskEnginePrompt)());
            ...
            let existingContent = '';
            try {
                existingContent = fs_1.default.readFileSync(agentsMdPath, 'utf8');
            }
            catch {
            ...
            const markerIdx = (0, constants_6.findAgentsMdManagedMarker)(existingContent)?.index ?? -1;
            const userContent = markerIdx >= 0 ? existingContent.slice(0, markerIdx).trimEnd() : existingContent.trimEnd();
            ...
            const preservedUserContent = (0, upstreamBrief_1.pruneUpstreamBrief)(userContent || readBundledOpenClawAgentsTemplate());
            if (sections.length === 0) {
                ...
                if (markerIdx >= 0) {
                    if (preservedUserContent) {
                        ...
                        try {
                            fs_1.default.unlinkSync(agentsMdPath);
                        }
                        catch {
                            /* already gone */
                        }
     ...
     */
    buildAgentsList(defaultPrimaryModel, stateDir, availableProviders, agentsOverride, 
    ...
    lockToDefault = false) {
        ...
        const mainAgent = agents.find(agent => agent.id === agent_1.AgentId.Main);
        const list = [
            mainAgent
                ? (0, openclawAgentModels_1.buildAgentEntry)(mainAgent, defaultPrimaryModel, { availableProviders, lockToDefault })
                : {
                    id: agent_1.AgentId.Main,
                    default: true,
                    identity: {
            ...
            ...(0, openclawAgentModels_1.buildManagedAgentEntries)({
                agents,
    ...
    buildBindings() {
        ...
        if (!platformBindings || Object.keys(platformBindings).length === 0)
            return {};
        const agents = this.getAgents?.() ?? [];
        const bindings = [];
        // Handle per-instance bindings for multi-instance platforms
        const multiInstanceChannels = {
                ...
                if (platformAgentId && platformAgentId !== 'main') {
                    ...
                    if (targetAgent && instances.some(i => i.enabled)) {
                        bindings.push({
                            ...
                            match: { channel, accountId: exports.OPENCLAW_BINDING_ANY_ACCOUNT_ID },
                        });
                    }
                }
            }
     ...
     */
    syncPerAgentWorkspaces(mainWorkspaceDir, coworkConfig) {
        const agents = this.getAgents?.() ?? [];
        ...
        try {
            if ((0, openclawHeartbeatRepair_1.repairHeartbeatFile)(mainWorkspaceDir)) {
                console.log('[EngineConfigSync] Repaired legacy HEARTBEAT.md in main workspace');
            }
        }
        catch (error) {
            console.warn('[EngineConfigSync] Failed to repair HEARTBEAT.md in main workspace:', error instanceof Error ? error.message : String(error));
        }
        for (const agent of agents) {
            if (agent.id === 'main' || !agent.enabled)
                continue;
            const agentWorkspace = path_1.default.join(stateDir, `workspace-${agent.id}`);
            try {
                ensureDir(agentWorkspace);
                if ((0, openclawHeartbeatRepair_1.repairHeartbeatFile)(agentWorkspace)) {
                    console.log(`[EngineConfigSync] Repaired legacy HEARTBEAT.md for agent ${agent.id}`);
                }
                // Sync SOUL.md — agent's system prompt
                const soulPath = path_1.default.join(agentWorkspace, 'SOUL.md');
                ...
                const identityPath = path_1.default.join(agentWorkspace, 'IDENTITY.md');
                ...
                const memoryDir = path_1.default.join(agentWorkspace, 'memory');
                ensureDir(memoryDir);
                // Ensure MEMORY.md exists
                const memoryPath = path_1.default.join(agentWorkspace, 'MEMORY.md');
                if (!fs_1.default.existsSync(memoryPath)) {
                    fs_1.default.writeFileSync(memoryPath, '', 'utf8');
                }
            }
            catch (error) {
                console.warn(`[EngineConfigSync] Failed to sync workspace for agent ${agent.id}:`, error instanceof Error ? error.message : String(error));
            }
        }
    }
    ...
    projectsFor(agentId) {
        ...
        const projectsDir = path_1.default.join(this.engineManager.getStateDir(), 'projects');
        return projects.flatMap(project => {
            const memoryPath = path_1.default.join(projectsDir, project.slug, constants_8.PROJECT_MEMORY_FILE);
            try {
                ensureDir(path_1.default.dirname(memoryPath));
                if (!fs_1.default.existsSync(memoryPath)) {
                    fs_1.default.writeFileSync(memoryPath, `# ${project.name}\n\n`, 'utf8');
                }
            }
            catch (error) {
                // A project whose folder cannot be made is left out rather than
                // named with a path that does not work.
                console.warn(`[EngineConfigSync] Could not prepare the shared notes for "${project.name}":`, error instanceof Error ? error.message : String(error));
                return [];
            }
            return [{
                    name: project.name,
    ...
    syncAppUiMap(workspaceDir) {
        try {
            const mapPath = path_1.default.join(workspaceDir, ...appUiMap_1.APP_UI_MAP_PATH.split('/'));
            ensureDir(path_1.default.dirname(mapPath));
            this.syncFileIfChanged(mapPath, `${(0, appUiMap_1.buildAppUiMap)(appConstants_1.APP_NAME).trimEnd()}\n`);
        }
        catch (error) {
            console.warn('[EngineConfigSync] Failed to write the app UI map:', error instanceof Error ? error.message : String(error));
        }
        try {
            const failurePath = path_1.default.join(workspaceDir, ...whenThingsFail_1.WHEN_THINGS_FAIL_PATH.split('/'));
            ensureDir(path_1.default.dirname(failurePath));
            ...
            const reference = (0, whenThingsFail_1.buildFailureReference)({
                appName: appConstants_1.APP_NAME,
                logDir: path_1.default.dirname((0, logger_1.getLogFilePath)()),
                ...optional('gatewayLogDir', () => path_1.default.dirname(this.engineManager.getGatewayLogPath())),
                ...optional('engineConfigPath', () => this.engineManager.getConfigPath()),
            });
            this.syncFileIfChanged(failurePath, `${reference.trimEnd()}\n`);
        }
        catch (error) {
            console.warn('[EngineConfigSync] Failed to write the failure reference:', error instanceof Error ? error.message : String(error));
        }
    }
    syncFileIfChanged(filePath, content) {
        try {
     ...
     */
    writeMinimalConfig(configPath, _reason) {
        const baseMinimalConfig = {
            gateway: {
                mode: 'local',
            },
        ...
        let mergedConfig = { ...baseMinimalConfig };
        if (currentContent) {
            try {
...
exports.OpenClawConfigSync = OpenClawConfigSync;
//# sourceMappingURL=openclawConfigSync.js.map