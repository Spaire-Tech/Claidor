...
exports.CoworkModelProtocol = void 0;
exports.buildAnthropicMessagesUrl = buildAnthropicMessagesUrl;
exports.normalizeGeminiBaseUrl = normalizeGeminiBaseUrl;
exports.buildGeminiGenerateContentUrl = buildGeminiGenerateContentUrl;
exports.extractApiErrorSnippet = extractApiErrorSnippet;
exports.extractTextFromAnthropicResponse = extractTextFromAnthropicResponse;
exports.extractTextFromGeminiResponse = extractTextFromGeminiResponse;
exports.CoworkModelProtocol = {
    Anthropic: 'anthropic',
...
const toRecord = (value) => (value && typeof value === 'object' && !Array.isArray(value)
    ? value
    : null);
const collectTextFromUnknown = (value) => {
...
//# sourceMappingURL=coworkModelApi.js.map