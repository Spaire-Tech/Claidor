...
function getRulesForFile(relativePath) {
    ...
    return exports.ALL_SECURITY_RULES.filter(rule => rule.filePatterns.some(pattern => matchesGlobSuffix(pattern, ext, relativePath)));
}
function getExtension(filePath) {
    const lastDot = filePath.lastIndexOf('.');
    return lastDot >= 0 ? filePath.substring(lastDot) : '';
}
function matchesGlobSuffix(pattern, ext, filePath) {
...
//# sourceMappingURL=skillSecurityRules.js.map