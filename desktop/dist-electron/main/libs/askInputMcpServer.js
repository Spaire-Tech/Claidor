...
exports.resolveAskInputMcpStdioLaunch = void 0;
...
const tools = [{
  name: '${constants_1.ASK_INPUT_TOOL}',
...
async function handleRequest(message) {
  ...
  if (message.method === 'initialize') {
    ...
    result = message.params?.name === '${constants_1.ASK_INPUT_TOOL}'
...
const prepare = (baseDir, options) => {
    ...
    const serverDir = path_1.default.join(baseDir, 'ask-input-mcp');
    ...
    writeFileIfChanged(path_1.default.join(serverDir, RUNTIME_CONFIG_FILE_NAME), `${JSON.stringify({ version: 1, bridgeUrl: options.bridgeUrl, bridgeSecret: options.bridgeSecret }, null, 2)}\n`, 0o600);
    return { serverDir };
};
const resolveAskInputMcpStdioLaunch = (baseDir, options) => {
...
exports.resolveAskInputMcpStdioLaunch = resolveAskInputMcpStdioLaunch;
//# sourceMappingURL=askInputMcpServer.js.map