...
exports.parseMediaMarkers = parseMediaMarkers;
exports.stripMediaMarkers = stripMediaMarkers;
// 文件扩展名分类
 ...
 * 从文本中移除已处理的媒体标记
 */
function stripMediaMarkers(text, markers) {
    let result = text;
...
//# sourceMappingURL=dingtalkMediaParser.js.map