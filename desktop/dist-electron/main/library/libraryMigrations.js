...
exports.initializeLibraryTables = void 0;
const initializeLibraryTables = (db) => {
    db.transaction(() => {
        db.exec(`
...
exports.initializeLibraryTables = initializeLibraryTables;
//# sourceMappingURL=libraryMigrations.js.map