...
export function DevShell({ upstreamBoot }: DevShellProps) {
  ...
  const previewPlugins: PluginsDialogShellProps["items"] = [
    { kind: "plugin", id: "calendar", displayName: "Calendar", description: "Read events and coordinate schedules.", publisher: "Simeon", installed: false },
    { kind: "plugin", id: "linear", displayName: "Linear", description: "Search and update issues and projects.", publisher: "Simeon", installed: true },
