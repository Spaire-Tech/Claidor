...
export const PRIVACY_BLOCK_LABELS = {
  ...
  description: "Privacy Mode (Legacy) isn’t compatible with Caisra. Switch to Privacy Mode to start using Caisra — data still isn’t used for training.",
  support: "This setting is shared with Claidor. Leaving Legacy can’t be undone.",
  signOut: "Sign out",
