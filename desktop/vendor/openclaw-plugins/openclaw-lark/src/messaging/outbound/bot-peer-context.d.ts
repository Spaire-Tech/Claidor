 ...
 */
export declare function runWithBotPeerContext<T>(ctx: BotPeerContext, fn: () => Promise<T>): Promise<T>;
/**
 ...
 */
export declare function currentBotPeerContext(): BotPeerContext | undefined;
