export function createEgressConnectionObserver<TConnection>() {
  ...
  return {
    wrap<T extends { connect(): Promise<TConnection>; recreate?: (...args: any[]) => any; forceRecreate?: (...args: any[]) => any; issueLocalExecDaemonCredential?: (...args: any[]) => any; issueInferenceCredential?: (...args: any[]) => any }>(base: T) {
      return {
