...
function PromptSuggestionMessageComponent(props: PromptProps) {
  return jsxs("section", {
    ...
    children: [
      jsx("p", { children: "[SUGGESTION MODE: Suggest what user might naturally type next into Simeon.]" }),
      ...
      jsxs("ul", {
        children: [
          ...
          jsx("li", { children: "Simeon offers options → suggest the one the user would likely pick, based on conversation" }),
          jsx("li", { children: 'Simeon asks to continue or says it will do something next → "yes" or "Go ahead"' }),
