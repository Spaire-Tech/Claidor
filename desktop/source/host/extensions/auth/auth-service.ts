...
export const SAND_SHORTLIVED_CREDS_WAITING_MESSAGE = "Waiting for an inference credential. Caisra's computer renews this automatically (no desktop required); this resolves on its own shortly.";
