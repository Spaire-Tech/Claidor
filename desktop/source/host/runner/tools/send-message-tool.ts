...
export function createSendMessageTool(deps: SendMessageDependencies<Context>) {
  ...
  return createZodAgentTool("SEND_MESSAGE", {
    ...
    descriptionGenerator: () => describeSendMessageTool(),
