...
> A real corpus model produces a report that survives a hostile read by the founder: findings ranked, coverage stated on its face, every claim citable to a cell, refusals in words, and no sentence in it that the engine cannot defend.
