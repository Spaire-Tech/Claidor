...
You can easily offer customers and subscribers access to downloadable files with Claidor.
...
Deleting a file permanently deletes it from Claidor and our S3 buckets except for the metadata. Disable the file instead if you don't want it permanently deleted.
