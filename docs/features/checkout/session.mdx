...
Link the checkout to a customer in your system using `external_customer_id`. After a successful checkout, the Claidor customer will have this ID set as `external_id`, making it easy to look up billing state without storing Claidor IDs.
