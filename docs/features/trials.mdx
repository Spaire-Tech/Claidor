---
title: "Trials"
description: "Let customers experience your product before they commit. Claidor handles the billing delay, payment collection, and abuse prevention automatically."
---
...
3. At the end of the trial, Claidor charges the customer automatically
...
When enabled, Claidor blocks a new trial checkout if either of these matches a previous trial redemption:
