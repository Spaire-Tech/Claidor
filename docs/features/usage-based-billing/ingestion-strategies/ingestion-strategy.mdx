---
title: "Strategies Introduction"
description: "Ingestion blueprints for Usage Based Billing"
---

Claidor offers an ingestion framework to work with Claidor's event ingestion API.
