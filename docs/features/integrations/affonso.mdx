---
title: "Affonso Affiliates with Claidor"
sidebarTitle: "Affonso Affiliates"
---

This guide explains how to integrate
[Affonso](https://affonso.io)'s affiliate marketing software with your Claidor
...
### 1. Create a Claidor Access Token for Affonso

First, you'll need to create an API token in Claidor that Affonso can use to communicate with your account:

1. Login to your **Claidor Dashboard**
...
<video controls width="600">
  <source
  src="https://affonso-videos.s3.eu-central-1.amazonaws.com/Connect_Claidor_Affonso_1.mp4"
  type="video/mp4" />
</video>


### 2. Set Up Webhooks in Claidor

After connecting your Claidor account with Affonso, you'll [receive a webhook URL and secret from Affonso](https://affonso.io/app/affiliate-program/connect). Add these to your Claidor account:

1. Go to **Settings** → **Developers** → **Webhooks** in your Claidor Dashboard
...
<video controls width="600">
  <source
  src="https://affonso-videos.s3.eu-central-1.amazonaws.com/Connect_Claidor_Affonso_2.mp4"
  type="video/mp4" />
</video>
...
### 5. Pass Referral Data to Claidor Checkout
...
// Create checkout session with Claidor
...
3. When the user makes a purchase, the referral ID is passed to Claidor as metadata
4. Claidor's webhook notifies Affonso about the purchase
...
More details about the integration: [Claidor Affiliate Program](https://affonso.io/claidor-affiliate-program)
