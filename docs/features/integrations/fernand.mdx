---
title: "Claidor Integration in Fernand"
sidebarTitle: "Fernand"
description: "Learn how to sync customer and payment data from Claidor to Fernand."
---
...
After connecting your [Claidor](https://www.claidorhq.com/) account to Fernand, you’ll be able to see customer payment information and product access details directly within each customer conversation.
...
## How to connect Fernand with Claidor
...
2. Click on **Connect Claidor**.
3. You'll be redirected to Claidor to authorize the connection.
4. Once approved, Fernand will begin syncing customer data automatically.

That’s it! You’ll now see Claidor customer info directly in Fernand's conversation list and sidebar.

---

## How to automate your inbox with Claidor data

Once Claidor is connected, you can create automation rules in Fernand based on Claidor data.
...
<Steps>
  ...
  <Step title="Select a condition">
    Now add a condition based on Claidor data. For example:
...
If you ever want to disconnect Claidor from your Fernand workspace:
<Steps>
<Step title="Go to the Integrations page."></Step>
<Step title="Click Disconnect next to Claidor."></Step>
</Steps>

Deleting your organization on Fernand will also remove the Claidor integration automatically.
