...
export const builtinAgentTools: ConnectorTool[] = [
  ...
  },
  {
    ...
    // Exactly one destination: credential XOR connectionId. The pi runtime
    // flattens this union on the wire; sibling optionals looked schema-valid to
    // models but the executor still rejects both and neither.
    inputSchema: {
      oneOf: [
        {
          type: "object",
