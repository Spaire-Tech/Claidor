...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "source", sa.String(20), nullable=False, server_default="space_signup"
        ),
    ...
    op.create_index(
        "ix_email_subscribers_organization_id", "email_subscribers", ["organization_id"]
    )
    op.create_index(
    ...
    op.create_index(
        "ix_email_subscribers_created_at", "email_subscribers", ["created_at"]
    )
    op.create_index(
        "ix_email_subscribers_deleted_at", "email_subscribers", ["deleted_at"]
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "organization_id", "slug", "deleted_at", name="email_segments_org_slug_key"
        ),
    )
    op.create_index(
        "ix_email_segments_organization_id", "email_segments", ["organization_id"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["segment_id"], ["email_segments.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["subscriber_id"], ["email_subscribers.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "segment_id",
    ...
    op.create_index(
        "ix_email_segment_subscribers_segment_id",
        "email_segment_subscribers",
        ["segment_id"],
    )
    op.create_index(
        "ix_email_segment_subscribers_subscriber_id",
        "email_segment_subscribers",
        ["subscriber_id"],
    )
    op.create_index(
        "ix_email_segment_subscribers_created_at",
        "email_segment_subscribers",
        ["created_at"],
    )
    op.create_index(
        "ix_email_segment_subscribers_deleted_at",
        "email_segment_subscribers",
        ["deleted_at"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(255),
            nullable=False,
            server_default="noreply@notifications.claidorhq.com",
        ),
        ...
        sa.ForeignKeyConstraint(
            ["segment_id"], ["email_segments.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_email_broadcasts_organization_id", "email_broadcasts", ["organization_id"]
    )
    op.create_index(
        "ix_email_broadcasts_created_at", "email_broadcasts", ["created_at"]
    )
    op.create_index(
        "ix_email_broadcasts_deleted_at", "email_broadcasts", ["deleted_at"]
    )
    ...
    op.create_index(
        "ix_email_broadcast_sends_broadcast_id",
        "email_broadcast_sends",
        ["broadcast_id"],
    )
    op.create_index(
        "ix_email_broadcast_sends_subscriber_id",
        "email_broadcast_sends",
        ["subscriber_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "ix_email_broadcast_sends_created_at", "email_broadcast_sends", ["created_at"]
    )
    op.create_index(
        "ix_email_broadcast_sends_deleted_at", "email_broadcast_sends", ["deleted_at"]
    )
