...
export function UserWelcome({ email }: schemas['UserWelcomeProps']) {
  return (
    <WrapperPolar>
      <Preview>Welcome to Simeon — a quick note from Bass</Preview>
      ...
      <Section>
        ...
        <BodyText>
          Simeon is meant to make that kind of thing as easy to build as it is
