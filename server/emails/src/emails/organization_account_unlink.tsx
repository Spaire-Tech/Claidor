  ...
  return (
    <WrapperPolar>
      ...
      <IntroWithHi>
        ...
        associated with organizations in Claidor have been detached. This update
            ...
            <ul className="ml-4 list-disc p-0">
              {organizations_unlinked.map((org: string) => (
                <li key={org} className="mt-2">
                  ...
                  <Link
                    href={`https://app.claidorhq.com/dashboard/${org}/finance/account`}
                  >
                    https://app.claidorhq.com/dashboard/{org}/finance/account
                  </Link>
                </li>
              ))}
            </ul>
