...
export function NotificationPerksUnlocked({
  ...
  return (
    <WrapperPolar>
      <Preview>
        🎉 Congrats on your first sale! You've unlocked the Simeon Startup
        Perks.
      </Preview>
      <IntroWithHi>
      ...
      <BodyText>
        You've unlocked the <strong>Simeon Startup Stack</strong> — exclusive
...
NotificationPerksUnlocked.PreviewProps = {
  ...
  perks_url: 'https://simeonlabs.com/dashboard/acme-inc/startup-stack',
}
