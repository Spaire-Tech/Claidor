    ...
    async def _get_snippets_card(
        ...
        snippets: list[tuple[str, str]] = [
            ...
            (
                "Cancellation Portal",
                (
                    "You can perform the cancellation on the following URL: https://app.simeonlabs.com/{organization_slug}/portal\n"
                ),
            ),
            (
                "Invoice Generation",
                (
                    "You can generate the invoice on the following URL: https://app.simeonlabs.com/{organization_slug}/portal\n"
                ),
            ),
            (
                "Follow-up 48 hours",
