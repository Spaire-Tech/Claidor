...
def _coverage(book: Workbook, result: Audit) -> None:
    ...
    #: A rule that already reported its own coverage keeps it: the
    #: unit checks count a population this pass cannot see.
    already = set(result.tallies) | {a.rule for a in result.abstentions}
